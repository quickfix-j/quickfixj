...
public class LegStreamEffectiveDateBusinessDayConvention extends IntField {
  static final long serialVersionUID = 552892318L;

  public static final int FIELD = 40250;
  ...
  public LegStreamEffectiveDateBusinessDayConvention(Integer data) {
    super(40250, data);
  }

  public LegStreamEffectiveDateBusinessDayConvention(int data) {
    super(40250, data);
  }
}
