...
public class UnderlyingProvisionDateBusinessDayConvention extends IntField {
  static final long serialVersionUID = 552892318L;

  public static final int FIELD = 42152;
  ...
  public UnderlyingProvisionDateBusinessDayConvention(Integer data) {
    super(42152, data);
  }

  public UnderlyingProvisionDateBusinessDayConvention(int data) {
    super(42152, data);
  }
}
