...
public class RequestingPartyRole extends IntField {
  static final long serialVersionUID = 552892318L;

  public static final int FIELD = 1660;
  ...
  public RequestingPartyRole(Integer data) {
    super(1660, data);
  }

  public RequestingPartyRole(int data) {
    super(1660, data);
  }
}
