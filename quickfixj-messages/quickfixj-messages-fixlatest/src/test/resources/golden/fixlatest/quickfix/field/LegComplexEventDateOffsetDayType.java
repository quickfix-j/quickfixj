...
public class LegComplexEventDateOffsetDayType extends IntField {
  static final long serialVersionUID = 552892318L;

  public static final int FIELD = 41393;
  ...
  public LegComplexEventDateOffsetDayType(Integer data) {
    super(41393, data);
  }

  public LegComplexEventDateOffsetDayType(int data) {
    super(41393, data);
  }
}
