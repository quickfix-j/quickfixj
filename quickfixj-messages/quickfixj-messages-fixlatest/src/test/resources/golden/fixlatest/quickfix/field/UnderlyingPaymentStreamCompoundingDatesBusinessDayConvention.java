...
public class UnderlyingPaymentStreamCompoundingDatesBusinessDayConvention extends IntField {
  static final long serialVersionUID = 552892318L;

  public static final int FIELD = 42904;
  ...
  public UnderlyingPaymentStreamCompoundingDatesBusinessDayConvention(Integer data) {
    super(42904, data);
  }

  public UnderlyingPaymentStreamCompoundingDatesBusinessDayConvention(int data) {
    super(42904, data);
  }
}
