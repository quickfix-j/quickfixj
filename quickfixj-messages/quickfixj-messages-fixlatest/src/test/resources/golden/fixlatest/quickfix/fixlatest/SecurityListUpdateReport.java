...
public class SecurityListUpdateReport extends Message {
  ...
  public void set(quickfix.fixlatest.component.SecLstUpdRelSymGrp component) {
    setComponent(component);
  }

  public quickfix.fixlatest.component.SecLstUpdRelSymGrp get(quickfix.fixlatest.component.SecLstUpdRelSymGrp component) throws FieldNotFound {
    getComponent(component);
    return component;
  }

  public quickfix.fixlatest.component.SecLstUpdRelSymGrp getSecLstUpdRelSymGrpComponent() throws FieldNotFound {
    return get(new quickfix.fixlatest.component.SecLstUpdRelSymGrp());
  }
