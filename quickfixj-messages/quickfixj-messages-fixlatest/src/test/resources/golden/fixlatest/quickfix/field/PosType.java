...
public class PosType extends StringField {
  ...
  public static final String NET_QTY = "NET";

  public static final String GROSS_QTY = "GRS";

  public static final String INTRADAY_QTY = "ITD";

  public static final String GROSS_LONG_NON_DELTA_ADJUSTED_SWAPTION_POSITION = "NDAS";

  public static final String LONG_DELTA_ADJUSTED_PAIRED_SWAPTION_POSITION = "DAS";

  public static final String EXPIRING_QUANTITY = "EXP";

  public static final String QUANTITY_NOT_EXERCISED = "UNEX";

  public static final String REQUESTED_EXERCISE_QUANTITY = "REQ";

  public static final String CASH_FUTURES_EQUIVALENT_QUANTITY = "CFE";

  public static final String LOAN_OR_BORROWED_QUANTITY = "SECLN";
