...
public class LegComplexEventDateBusinessDayConvention extends IntField {
  static final long serialVersionUID = 552892318L;

  public static final int FIELD = 41394;
  ...
  public LegComplexEventDateBusinessDayConvention(Integer data) {
    super(41394, data);
  }

  public LegComplexEventDateBusinessDayConvention(int data) {
    super(41394, data);
  }
}
