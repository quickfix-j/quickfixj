...
public class LegStreamCommoditySettlDateBusinessDayConvention extends IntField {
  static final long serialVersionUID = 552892318L;

  public static final int FIELD = 41666;
  ...
  public LegStreamCommoditySettlDateBusinessDayConvention(Integer data) {
    super(41666, data);
  }

  public LegStreamCommoditySettlDateBusinessDayConvention(int data) {
    super(41666, data);
  }
}
