...
public class PricingDateBusinessDayConvention extends IntField {
  static final long serialVersionUID = 552892318L;

  public static final int FIELD = 41233;
  ...
  public PricingDateBusinessDayConvention(Integer data) {
    super(41233, data);
  }

  public PricingDateBusinessDayConvention(int data) {
    super(41233, data);
  }
}
