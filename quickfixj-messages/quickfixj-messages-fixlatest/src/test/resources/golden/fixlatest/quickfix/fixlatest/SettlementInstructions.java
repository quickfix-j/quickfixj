...
public class SettlementInstructions extends Message {
  ...
  public void set(quickfix.fixlatest.component.SettlInstGrp component) {
    setComponent(component);
  }

  public quickfix.fixlatest.component.SettlInstGrp get(quickfix.fixlatest.component.SettlInstGrp component) throws FieldNotFound {
    getComponent(component);
    return component;
  }

  public quickfix.fixlatest.component.SettlInstGrp getSettlInstGrpComponent() throws FieldNotFound {
    return get(new quickfix.fixlatest.component.SettlInstGrp());
  }
...
public static class NoSettlInst extends Group {
  static final long serialVersionUID = 552892318L;
  private static final int[]  ORDER = {162, 163, 214, 453, 54, 460, 167, 461, 2891, 120, 168, 126, 779, 172, 169, 170, 171, 85, 492, 476, 488, 489, 503, 490, 491, 504, 505, 0};
