...
public class UnderlyingPaymentStubEndDateOffsetDayType extends IntField {
  static final long serialVersionUID = 552892318L;

  public static final int FIELD = 42989;
  ...
  public UnderlyingPaymentStubEndDateOffsetDayType(Integer data) {
    super(42989, data);
  }

  public UnderlyingPaymentStubEndDateOffsetDayType(int data) {
    super(42989, data);
  }
}
