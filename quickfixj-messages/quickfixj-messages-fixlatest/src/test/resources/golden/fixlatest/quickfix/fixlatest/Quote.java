...
public class Quote extends Message {
  ...
  public void set(quickfix.field.QuoteModelType value) {
    setField(value);
  }

  public quickfix.field.QuoteModelType get(quickfix.field.QuoteModelType value) throws FieldNotFound {
    getField(value);
    return value;
  }

  public quickfix.field.QuoteModelType getQuoteModelType() throws FieldNotFound {
    return get(new quickfix.field.QuoteModelType());
  }

  public boolean isSet(quickfix.field.QuoteModelType field) {
    return isSetField(field);
  }

  public boolean isSetQuoteModelType() {
    return isSetField(2403);
  }
  ...
  public void set(quickfix.field.SingleQuoteIndicator value) {
    setField(value);
  }

  public quickfix.field.SingleQuoteIndicator get(quickfix.field.SingleQuoteIndicator value) throws FieldNotFound {
    getField(value);
    return value;
  }

  public quickfix.field.SingleQuoteIndicator getSingleQuoteIndicator() throws FieldNotFound {
    return get(new quickfix.field.SingleQuoteIndicator());
  }

  public boolean isSet(quickfix.field.SingleQuoteIndicator field) {
    return isSetField(field);
  }

  public boolean isSetSingleQuoteIndicator() {
    return isSetField(2837);
  }
...
public static class NoPriceQualifiers extends Group {
  ...
  public void set(quickfix.field.BidSpread value) {
    setField(value);
  }

  public quickfix.field.BidSpread get(quickfix.field.BidSpread value) throws FieldNotFound {
    getField(value);
    return value;
  }

  public quickfix.field.BidSpread getBidSpread() throws FieldNotFound {
    return get(new quickfix.field.BidSpread());
  }

  public boolean isSet(quickfix.field.BidSpread field) {
    return isSetField(field);
  }

  public boolean isSetBidSpread() {
    return isSetField(2533);
  }

  public void set(quickfix.field.OfferSpread value) {
    setField(value);
  }

  public quickfix.field.OfferSpread get(quickfix.field.OfferSpread value) throws FieldNotFound {
    getField(value);
    return value;
  }

  public quickfix.field.OfferSpread getOfferSpread() throws FieldNotFound {
    return get(new quickfix.field.OfferSpread());
  }

  public boolean isSet(quickfix.field.OfferSpread field) {
    return isSetField(field);
  }

  public boolean isSetOfferSpread() {
    return isSetField(2534);
  }
