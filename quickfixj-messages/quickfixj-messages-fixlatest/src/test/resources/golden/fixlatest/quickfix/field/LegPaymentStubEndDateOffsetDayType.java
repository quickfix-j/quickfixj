...
public class LegPaymentStubEndDateOffsetDayType extends IntField {
  static final long serialVersionUID = 552892318L;

  public static final int FIELD = 42493;
  ...
  public LegPaymentStubEndDateOffsetDayType(Integer data) {
    super(42493, data);
  }

  public LegPaymentStubEndDateOffsetDayType(int data) {
    super(42493, data);
  }
}
