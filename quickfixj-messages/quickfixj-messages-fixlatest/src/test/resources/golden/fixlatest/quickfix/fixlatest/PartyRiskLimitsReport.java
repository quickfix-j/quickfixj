...
public class PartyRiskLimitsReport extends Message {
  static final long serialVersionUID = 552892318L;

  public static final String MSGTYPE = "CM";

  public PartyRiskLimitsReport() {
    super();
    getHeader().setField(new quickfix.field.MsgType(MSGTYPE));
  }

  public PartyRiskLimitsReport (quickfix.field.RiskLimitReportID riskLimitReportID) {
    this();
  ...
  public void set(quickfix.field.RequestResult value) {
    setField(value);
  }

  public quickfix.field.RequestResult get(quickfix.field.RequestResult value) throws FieldNotFound {
    getField(value);
    return value;
  }

  public quickfix.field.RequestResult getRequestResult() throws FieldNotFound {
    return get(new quickfix.field.RequestResult());
  }

  public boolean isSet(quickfix.field.RequestResult field) {
    return isSetField(field);
  }

  public boolean isSetRequestResult() {
  ...
  public void set(quickfix.fixlatest.component.PartyRiskLimitsGrp component) {
    setComponent(component);
  }

  public quickfix.fixlatest.component.PartyRiskLimitsGrp get(quickfix.fixlatest.component.PartyRiskLimitsGrp component) throws FieldNotFound {
    getComponent(component);
    return component;
  }

  public quickfix.fixlatest.component.PartyRiskLimitsGrp getPartyRiskLimitsGrpComponent() throws FieldNotFound {
    return get(new quickfix.fixlatest.component.PartyRiskLimitsGrp());
  }
...
public static class NoPartyRiskLimits extends Group {
  static final long serialVersionUID = 552892318L;
  private static final int[]  ORDER = {1671, 1669, 1670, 2339, 2355, 0};

  public NoPartyRiskLimits() {
    super(1677, 1671, ORDER);
  }
