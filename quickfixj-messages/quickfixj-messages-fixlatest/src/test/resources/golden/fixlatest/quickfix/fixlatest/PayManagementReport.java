...
public class PayManagementReport extends Message {
  static final long serialVersionUID = 552892318L;

  public static final String MSGTYPE = "EA";

  public PayManagementReport() {
    super();
    getHeader().setField(new quickfix.field.MsgType(MSGTYPE));
  }

  public PayManagementReport (quickfix.field.PayReportID payReportID, quickfix.field.PayReportTransType payReportTransType, quickfix.field.TransactTime transactTime) {
    this();
    setField(payReportID);
    setField(payReportTransType);
  ...
  public void set(quickfix.field.PayReportTransType value) {
    setField(value);
  }

  public quickfix.field.PayReportTransType get(quickfix.field.PayReportTransType value) throws FieldNotFound {
    getField(value);
    return value;
  }

  public quickfix.field.PayReportTransType getPayReportTransType() throws FieldNotFound {
    return get(new quickfix.field.PayReportTransType());
  }

  public boolean isSet(quickfix.field.PayReportTransType field) {
    return isSetField(field);
  }

  public boolean isSetPayReportTransType() {
    return isSetField(2804);
  }

  public void set(quickfix.field.PayReportRefID value) {
    setField(value);
  }

  public quickfix.field.PayReportRefID get(quickfix.field.PayReportRefID value) throws FieldNotFound {
    getField(value);
    return value;
  }

  public quickfix.field.PayReportRefID getPayReportRefID() throws FieldNotFound {
    return get(new quickfix.field.PayReportRefID());
  }

  public boolean isSet(quickfix.field.PayReportRefID field) {
    return isSetField(field);
  }

  public boolean isSetPayReportRefID() {
    return isSetField(2803);
  }

  public void set(quickfix.field.ReplaceText value) {
    setField(value);
  }

  public quickfix.field.ReplaceText get(quickfix.field.ReplaceText value) throws FieldNotFound {
    getField(value);
    return value;
  }

  public quickfix.field.ReplaceText getReplaceText() throws FieldNotFound {
    return get(new quickfix.field.ReplaceText());
  }

  public boolean isSet(quickfix.field.ReplaceText field) {
    return isSetField(field);
  }

  public boolean isSetReplaceText() {
    return isSetField(2805);
  }

  public void set(quickfix.field.EncodedReplaceTextLen value) {
    setField(value);
  }

  public quickfix.field.EncodedReplaceTextLen get(quickfix.field.EncodedReplaceTextLen value) throws FieldNotFound {
    getField(value);
    return value;
  }

  public quickfix.field.EncodedReplaceTextLen getEncodedReplaceTextLen() throws FieldNotFound {
    return get(new quickfix.field.EncodedReplaceTextLen());
  }

  public boolean isSet(quickfix.field.EncodedReplaceTextLen field) {
    return isSetField(field);
  }

  public boolean isSetEncodedReplaceTextLen() {
    return isSetField(2802);
  }

  public void set(quickfix.field.EncodedReplaceText value) {
    setField(value);
  }

  public quickfix.field.EncodedReplaceText get(quickfix.field.EncodedReplaceText value) throws FieldNotFound {
    getField(value);
    return value;
  }

  public quickfix.field.EncodedReplaceText getEncodedReplaceText() throws FieldNotFound {
    return get(new quickfix.field.EncodedReplaceText());
  }

  public boolean isSet(quickfix.field.EncodedReplaceText field) {
    return isSetField(field);
  }

  public boolean isSetEncodedReplaceText() {
    return isSetField(2801);
  }
