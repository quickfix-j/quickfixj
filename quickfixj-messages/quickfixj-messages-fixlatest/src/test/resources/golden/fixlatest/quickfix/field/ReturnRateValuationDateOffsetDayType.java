...
public class ReturnRateValuationDateOffsetDayType extends IntField {
  static final long serialVersionUID = 552892318L;

  public static final int FIELD = 42714;
  ...
  public ReturnRateValuationDateOffsetDayType(Integer data) {
    super(42714, data);
  }

  public ReturnRateValuationDateOffsetDayType(int data) {
    super(42714, data);
  }
}
