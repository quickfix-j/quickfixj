...
public class LegProvisionCashSettlPaymentDateBusinessDayConvention extends IntField {
  static final long serialVersionUID = 552892318L;

  public static final int FIELD = 40516;
  ...
  public LegProvisionCashSettlPaymentDateBusinessDayConvention(Integer data) {
    super(40516, data);
  }

  public LegProvisionCashSettlPaymentDateBusinessDayConvention(int data) {
    super(40516, data);
  }
}
