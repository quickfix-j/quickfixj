...
public class StreamEffectiveDateBusinessDayConvention extends IntField {
  static final long serialVersionUID = 552892318L;

  public static final int FIELD = 40908;
  ...
  public StreamEffectiveDateBusinessDayConvention(Integer data) {
    super(40908, data);
  }

  public StreamEffectiveDateBusinessDayConvention(int data) {
    super(40908, data);
  }
}
