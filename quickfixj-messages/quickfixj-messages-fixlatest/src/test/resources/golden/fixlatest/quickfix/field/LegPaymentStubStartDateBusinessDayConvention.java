...
public class LegPaymentStubStartDateBusinessDayConvention extends IntField {
  static final long serialVersionUID = 552892318L;

  public static final int FIELD = 42498;
  ...
  public LegPaymentStubStartDateBusinessDayConvention(Integer data) {
    super(42498, data);
  }

  public LegPaymentStubStartDateBusinessDayConvention(int data) {
    super(42498, data);
  }
}
