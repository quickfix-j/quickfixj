...
public class PaymentStreamNonDeliverableFixingDatesBusinessDayConvention extends IntField {
  static final long serialVersionUID = 552892318L;

  public static final int FIELD = 40818;
  ...
  public PaymentStreamNonDeliverableFixingDatesBusinessDayConvention(Integer data) {
    super(40818, data);
  }

  public PaymentStreamNonDeliverableFixingDatesBusinessDayConvention(int data) {
    super(40818, data);
  }
}
