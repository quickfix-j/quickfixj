...
public class UnderlyingEventType extends IntField {
  static final long serialVersionUID = 552892318L;

  public static final int FIELD = 1982;
  ...
  public UnderlyingEventType(Integer data) {
    super(1982, data);
  }

  public UnderlyingEventType(int data) {
    super(1982, data);
  }
}
