...
public class LegPaymentScheduleFixingDateBusinessDayConvention extends IntField {
  static final long serialVersionUID = 552892318L;

  public static final int FIELD = 40399;
  ...
  public LegPaymentScheduleFixingDateBusinessDayConvention(Integer data) {
    super(40399, data);
  }

  public LegPaymentScheduleFixingDateBusinessDayConvention(int data) {
    super(40399, data);
  }
}
