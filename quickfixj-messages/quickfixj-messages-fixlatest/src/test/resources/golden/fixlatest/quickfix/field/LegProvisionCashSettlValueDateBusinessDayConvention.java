...
public class LegProvisionCashSettlValueDateBusinessDayConvention extends IntField {
  static final long serialVersionUID = 552892318L;

  public static final int FIELD = 40526;
  ...
  public LegProvisionCashSettlValueDateBusinessDayConvention(Integer data) {
    super(40526, data);
  }

  public LegProvisionCashSettlValueDateBusinessDayConvention(int data) {
    super(40526, data);
  }
}
