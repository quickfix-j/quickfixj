...
public class LegPricingDateBusinessDayConvention extends IntField {
  static final long serialVersionUID = 552892318L;

  public static final int FIELD = 41610;
  ...
  public LegPricingDateBusinessDayConvention(Integer data) {
    super(41610, data);
  }

  public LegPricingDateBusinessDayConvention(int data) {
    super(41610, data);
  }
}
