...
public class UnderlyingStreamEffectiveDateBusinessDayConvention extends IntField {
  static final long serialVersionUID = 552892318L;

  public static final int FIELD = 40058;
  ...
  public UnderlyingStreamEffectiveDateBusinessDayConvention(Integer data) {
    super(40058, data);
  }

  public UnderlyingStreamEffectiveDateBusinessDayConvention(int data) {
    super(40058, data);
  }
}
