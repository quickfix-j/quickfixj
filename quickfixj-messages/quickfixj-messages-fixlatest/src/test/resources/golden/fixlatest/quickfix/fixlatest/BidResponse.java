...
public class BidResponse extends Message {
  ...
  public void set(quickfix.fixlatest.component.BidCompRspGrp component) {
    setComponent(component);
  }

  public quickfix.fixlatest.component.BidCompRspGrp get(quickfix.fixlatest.component.BidCompRspGrp component) throws FieldNotFound {
    getComponent(component);
    return component;
  }

  public quickfix.fixlatest.component.BidCompRspGrp getBidCompRspGrpComponent() throws FieldNotFound {
    return get(new quickfix.fixlatest.component.BidCompRspGrp());
  }
...
public static class NoBidComponents extends Group {
  static final long serialVersionUID = 552892318L;
  private static final int[]  ORDER = {12, 13, 479, 1233, 1238, 497, 66, 421, 54, 44, 423, 406, 430, 63, 64, 336, 625, 58, 354, 355, 0};
