...
public class LegDividendAccrualPaymentDateBusinessDayConvention extends IntField {
  static final long serialVersionUID = 552892318L;

  public static final int FIELD = 42335;
  ...
  public LegDividendAccrualPaymentDateBusinessDayConvention(Integer data) {
    super(42335, data);
  }

  public LegDividendAccrualPaymentDateBusinessDayConvention(int data) {
    super(42335, data);
  }
}
