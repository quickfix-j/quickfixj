...
public class TradeMatchReport extends Message {
  static final long serialVersionUID = 552892318L;

  public static final String MSGTYPE = "DC";

  public TradeMatchReport() {
    super();
    getHeader().setField(new quickfix.field.MsgType(MSGTYPE));
  }

  public TradeMatchReport (quickfix.field.TrdMatchID trdMatchID) {
    this();
    setField(trdMatchID);
  }
  ...
  public void set(quickfix.field.TradeMatchTimestamp value) {
    setField(value);
  }

  public quickfix.field.TradeMatchTimestamp get(quickfix.field.TradeMatchTimestamp value) throws FieldNotFound {
    getField(value);
    return value;
  }

  public quickfix.field.TradeMatchTimestamp getTradeMatchTimestamp() throws FieldNotFound {
    return get(new quickfix.field.TradeMatchTimestamp());
  }

  public boolean isSet(quickfix.field.TradeMatchTimestamp field) {
    return isSetField(field);
  }

  public boolean isSetTradeMatchTimestamp() {
    return isSetField(1888);
  }
  ...
  public void set(quickfix.fixlatest.component.InstrmtMatchSideGrp component) {
    setComponent(component);
  }

  public quickfix.fixlatest.component.InstrmtMatchSideGrp get(quickfix.fixlatest.component.InstrmtMatchSideGrp component) throws FieldNotFound {
    getComponent(component);
    return component;
  }

  public quickfix.fixlatest.component.InstrmtMatchSideGrp getInstrmtMatchSideGrpComponent() throws FieldNotFound {
    return get(new quickfix.fixlatest.component.InstrmtMatchSideGrp());
  }
