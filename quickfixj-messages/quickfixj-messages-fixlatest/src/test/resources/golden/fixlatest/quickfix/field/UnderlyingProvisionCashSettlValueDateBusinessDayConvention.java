...
public class UnderlyingProvisionCashSettlValueDateBusinessDayConvention extends IntField {
  static final long serialVersionUID = 552892318L;

  public static final int FIELD = 42106;
  ...
  public UnderlyingProvisionCashSettlValueDateBusinessDayConvention(Integer data) {
    super(42106, data);
  }

  public UnderlyingProvisionCashSettlValueDateBusinessDayConvention(int data) {
    super(42106, data);
  }
}
