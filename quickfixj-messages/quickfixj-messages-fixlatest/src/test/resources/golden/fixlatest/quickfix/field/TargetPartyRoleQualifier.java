...
public class TargetPartyRoleQualifier extends IntField {
  static final long serialVersionUID = 552892318L;

  public static final int FIELD = 1818;
  ...
  public TargetPartyRoleQualifier(Integer data) {
    super(1818, data);
  }

  public TargetPartyRoleQualifier(int data) {
    super(1818, data);
  }
}
