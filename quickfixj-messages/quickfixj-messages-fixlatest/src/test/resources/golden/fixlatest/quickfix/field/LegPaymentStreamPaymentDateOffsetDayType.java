...
public class LegPaymentStreamPaymentDateOffsetDayType extends IntField {
  static final long serialVersionUID = 552892318L;

  public static final int FIELD = 40302;
  ...
  public LegPaymentStreamPaymentDateOffsetDayType(Integer data) {
    super(40302, data);
  }

  public LegPaymentStreamPaymentDateOffsetDayType(int data) {
    super(40302, data);
  }
}
