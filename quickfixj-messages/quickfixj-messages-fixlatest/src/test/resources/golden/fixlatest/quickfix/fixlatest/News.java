...
public class News extends Message {
  ...
  public void set(quickfix.field.NewsID value) {
    setField(value);
  }

  public quickfix.field.NewsID get(quickfix.field.NewsID value) throws FieldNotFound {
    getField(value);
    return value;
  }
  ...
  public boolean isSet(quickfix.field.NewsID field) {
    return isSetField(field);
  }

  public boolean isSetNewsID() {
    return isSetField(1472);
  }

  public void set(quickfix.fixlatest.component.NewsRefGrp component) {
    setComponent(component);
  }

  public quickfix.fixlatest.component.NewsRefGrp get(quickfix.fixlatest.component.NewsRefGrp component) throws FieldNotFound {
    getComponent(component);
    return component;
  }

  public quickfix.fixlatest.component.NewsRefGrp getNewsRefGrpComponent() throws FieldNotFound {
    return get(new quickfix.fixlatest.component.NewsRefGrp());
  }
...
public static class NoNewsRefIDs extends Group {
  ...
  public void set(quickfix.field.NewsCategory value) {
    setField(value);
  }

  public quickfix.field.NewsCategory get(quickfix.field.NewsCategory value) throws FieldNotFound {
    getField(value);
    return value;
  }
  ...
  public boolean isSet(quickfix.field.NewsCategory field) {
    return isSetField(field);
  }

  public boolean isSetNewsCategory() {
    return isSetField(1473);
  }

  public void set(quickfix.field.LanguageCode value) {
    setField(value);
  }

  public quickfix.field.LanguageCode get(quickfix.field.LanguageCode value) throws FieldNotFound {
    getField(value);
    return value;
  }

  public quickfix.field.LanguageCode getLanguageCode() throws FieldNotFound {
    return get(new quickfix.field.LanguageCode());
  }

  public boolean isSet(quickfix.field.LanguageCode field) {
    return isSetField(field);
  }

  public boolean isSetLanguageCode() {
    return isSetField(1474);
  }
...
public static class NoRoutingIDs extends Group {
  ...
  public void set(quickfix.fixlatest.component.InstrmtGrp component) {
    setComponent(component);
  }

  public quickfix.fixlatest.component.InstrmtGrp get(quickfix.fixlatest.component.InstrmtGrp component) throws FieldNotFound {
    getComponent(component);
    return component;
  }

  public quickfix.fixlatest.component.InstrmtGrp getInstrmtGrpComponent() throws FieldNotFound {
    return get(new quickfix.fixlatest.component.InstrmtGrp());
  }
