...
public class PaymentSettlPartyRoleQualifier extends IntField {
  static final long serialVersionUID = 552892318L;

  public static final int FIELD = 40237;
  ...
  public PaymentSettlPartyRoleQualifier(Integer data) {
    super(40237, data);
  }

  public PaymentSettlPartyRoleQualifier(int data) {
    super(40237, data);
  }
}
