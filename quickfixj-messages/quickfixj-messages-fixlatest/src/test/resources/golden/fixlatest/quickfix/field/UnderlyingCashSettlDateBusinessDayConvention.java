...
public class UnderlyingCashSettlDateBusinessDayConvention extends IntField {
  static final long serialVersionUID = 552892318L;

  public static final int FIELD = 42791;
  ...
  public UnderlyingCashSettlDateBusinessDayConvention(Integer data) {
    super(42791, data);
  }

  public UnderlyingCashSettlDateBusinessDayConvention(int data) {
    super(42791, data);
  }
}
