...
public class ReturnRateValuationStartDateOffsetDayType extends IntField {
  static final long serialVersionUID = 552892318L;

  public static final int FIELD = 42719;
  ...
  public ReturnRateValuationStartDateOffsetDayType(Integer data) {
    super(42719, data);
  }

  public ReturnRateValuationStartDateOffsetDayType(int data) {
    super(42719, data);
  }
}
