...
public class AllocationReport extends Message {
  ...
  public void set(quickfix.field.AllocReversalStatus value) {
    setField(value);
  }

  public quickfix.field.AllocReversalStatus get(quickfix.field.AllocReversalStatus value) throws FieldNotFound {
    getField(value);
    return value;
  }

  public quickfix.field.AllocReversalStatus getAllocReversalStatus() throws FieldNotFound {
    return get(new quickfix.field.AllocReversalStatus());
  }

  public boolean isSet(quickfix.field.AllocReversalStatus field) {
    return isSetField(field);
  }

  public boolean isSetAllocReversalStatus() {
    return isSetField(1738);
  }
