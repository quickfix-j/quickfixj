...
public class LegPaymentStreamPricingDayType extends IntField {
  static final long serialVersionUID = 552892318L;

  public static final int FIELD = 41582;
  ...
  public LegPaymentStreamPricingDayType(Integer data) {
    super(41582, data);
  }

  public LegPaymentStreamPricingDayType(int data) {
    super(41582, data);
  }
}
