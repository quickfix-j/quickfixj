...
public class MarketDataStatisticsRequest extends Message {
  static final long serialVersionUID = 552892318L;

  public static final String MSGTYPE = "DO";

  public MarketDataStatisticsRequest() {
    super();
    getHeader().setField(new quickfix.field.MsgType(MSGTYPE));
  }

  public MarketDataStatisticsRequest (quickfix.field.MDStatisticReqID mDStatisticReqID, quickfix.field.SubscriptionRequestType subscriptionRequestType) {
    this();
    setField(mDStatisticReqID);
    setField(subscriptionRequestType);
  }

  public void set(quickfix.field.MDStatisticReqID value) {
    setField(value);
  }

  public quickfix.field.MDStatisticReqID get(quickfix.field.MDStatisticReqID value) throws FieldNotFound {
    getField(value);
    return value;
  }

  public quickfix.field.MDStatisticReqID getMDStatisticReqID() throws FieldNotFound {
    return get(new quickfix.field.MDStatisticReqID());
  }

  public boolean isSet(quickfix.field.MDStatisticReqID field) {
    return isSetField(field);
  }

  public boolean isSetMDStatisticReqID() {
    return isSetField(2452);
  }
...
public static class NoRelatedInstruments extends Group {
  ...
  public void set(quickfix.fixlatest.component.MDStatisticReqGrp component) {
    setComponent(component);
  }

  public quickfix.fixlatest.component.MDStatisticReqGrp get(quickfix.fixlatest.component.MDStatisticReqGrp component) throws FieldNotFound {
    getComponent(component);
    return component;
  }

  public quickfix.fixlatest.component.MDStatisticReqGrp getMDStatisticReqGrpComponent() throws FieldNotFound {
    return get(new quickfix.fixlatest.component.MDStatisticReqGrp());
  }
