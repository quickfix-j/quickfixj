...
public class StreamCalculationPeriodBusinessDayConvention extends IntField {
  static final long serialVersionUID = 552892318L;

  public static final int FIELD = 40073;
  ...
  public StreamCalculationPeriodBusinessDayConvention(Integer data) {
    super(40073, data);
  }

  public StreamCalculationPeriodBusinessDayConvention(int data) {
    super(40073, data);
  }
}
