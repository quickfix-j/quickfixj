...
public class DerivativeInstrumentPartyRoleQualifier extends IntField {
  static final long serialVersionUID = 552892318L;

  public static final int FIELD = 2377;
  ...
  public DerivativeInstrumentPartyRoleQualifier(Integer data) {
    super(2377, data);
  }

  public DerivativeInstrumentPartyRoleQualifier(int data) {
    super(2377, data);
  }
}
