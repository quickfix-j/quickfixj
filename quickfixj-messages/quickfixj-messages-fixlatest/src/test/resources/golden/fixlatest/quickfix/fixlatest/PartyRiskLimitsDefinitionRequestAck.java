...
public class PartyRiskLimitsDefinitionRequestAck extends Message {
  static final long serialVersionUID = 552892318L;

  public static final String MSGTYPE = "CT";

  public PartyRiskLimitsDefinitionRequestAck() {
    super();
    getHeader().setField(new quickfix.field.MsgType(MSGTYPE));
  }

  public PartyRiskLimitsDefinitionRequestAck (quickfix.field.RiskLimitRequestID riskLimitRequestID, quickfix.field.RiskLimitRequestStatus riskLimitRequestStatus) {
    this();
    setField(riskLimitRequestID);
    setField(riskLimitRequestStatus);
  }
  ...
  public void set(quickfix.field.RiskLimitRequestResult value) {
    setField(value);
  }

  public quickfix.field.RiskLimitRequestResult get(quickfix.field.RiskLimitRequestResult value) throws FieldNotFound {
    getField(value);
    return value;
  }

  public quickfix.field.RiskLimitRequestResult getRiskLimitRequestResult() throws FieldNotFound {
    return get(new quickfix.field.RiskLimitRequestResult());
  }

  public boolean isSet(quickfix.field.RiskLimitRequestResult field) {
    return isSetField(field);
  }

  public boolean isSetRiskLimitRequestResult() {
    return isSetField(1761);
  }

  public void set(quickfix.field.RiskLimitRequestStatus value) {
    setField(value);
  }

  public quickfix.field.RiskLimitRequestStatus get(quickfix.field.RiskLimitRequestStatus value) throws FieldNotFound {
    getField(value);
    return value;
  }

  public quickfix.field.RiskLimitRequestStatus getRiskLimitRequestStatus() throws FieldNotFound {
    return get(new quickfix.field.RiskLimitRequestStatus());
  }

  public boolean isSet(quickfix.field.RiskLimitRequestStatus field) {
    return isSetField(field);
  }

  public boolean isSetRiskLimitRequestStatus() {
    return isSetField(1762);
  }
...
public static class NoRequestingPartySubIDs extends Group {
  ...
  public void set(quickfix.fixlatest.component.PartyRiskLimitsAckGrp component) {
    setComponent(component);
  }

  public quickfix.fixlatest.component.PartyRiskLimitsAckGrp get(quickfix.fixlatest.component.PartyRiskLimitsAckGrp component) throws FieldNotFound {
    getComponent(component);
    return component;
  }

  public quickfix.fixlatest.component.PartyRiskLimitsAckGrp getPartyRiskLimitsAckGrpComponent() throws FieldNotFound {
    return get(new quickfix.fixlatest.component.PartyRiskLimitsAckGrp());
  }
