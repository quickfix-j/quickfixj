...
public class UnderlyingPaymentScheduleType extends IntField {
  static final long serialVersionUID = 552892318L;

  public static final int FIELD = 40665;
  ...
  public UnderlyingPaymentScheduleType(Integer data) {
    super(40665, data);
  }

  public UnderlyingPaymentScheduleType(int data) {
    super(40665, data);
  }
}
