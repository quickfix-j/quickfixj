...
public class PartyActionRequest extends Message {
  static final long serialVersionUID = 552892318L;

  public static final String MSGTYPE = "DH";
  ...
  public PartyActionRequest (quickfix.field.PartyActionRequestID partyActionRequestID, quickfix.field.PartyActionType partyActionType) {
    this();
    setField(partyActionRequestID);
