...
public class UnderlyingSettlMethodElectionDateBusinessDayConvention extends IntField {
  static final long serialVersionUID = 552892318L;

  public static final int FIELD = 43077;
  ...
  public UnderlyingSettlMethodElectionDateBusinessDayConvention(Integer data) {
    super(43077, data);
  }

  public UnderlyingSettlMethodElectionDateBusinessDayConvention(int data) {
    super(43077, data);
  }
}
