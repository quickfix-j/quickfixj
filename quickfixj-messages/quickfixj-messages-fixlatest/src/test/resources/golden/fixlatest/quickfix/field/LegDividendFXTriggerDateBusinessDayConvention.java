...
public class LegDividendFXTriggerDateBusinessDayConvention extends IntField {
  static final long serialVersionUID = 552892318L;

  public static final int FIELD = 42362;
  ...
  public LegDividendFXTriggerDateBusinessDayConvention(Integer data) {
    super(42362, data);
  }

  public LegDividendFXTriggerDateBusinessDayConvention(int data) {
    super(42362, data);
  }
}
