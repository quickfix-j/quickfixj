...
public class MDStatisticDelayUnit extends IntField {
  static final long serialVersionUID = 552892318L;

  public static final int FIELD = 2463;
  ...
  public MDStatisticDelayUnit(Integer data) {
    super(2463, data);
  }

  public MDStatisticDelayUnit(int data) {
    super(2463, data);
  }
}
