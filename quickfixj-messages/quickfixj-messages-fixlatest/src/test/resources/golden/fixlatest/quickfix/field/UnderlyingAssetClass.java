...
public class UnderlyingAssetClass extends IntField {
  static final long serialVersionUID = 552892318L;

  public static final int FIELD = 2013;
  ...
  public UnderlyingAssetClass(Integer data) {
    super(2013, data);
  }

  public UnderlyingAssetClass(int data) {
    super(2013, data);
  }
}
