...
public class ExposureDurationUnit extends IntField {
  static final long serialVersionUID = 552892318L;

  public static final int FIELD = 1916;
  ...
  public ExposureDurationUnit(Integer data) {
    super(1916, data);
  }

  public ExposureDurationUnit(int data) {
    super(1916, data);
  }
}
