...
public class LegPaymentStreamResetDateBusinessDayConvention extends IntField {
  static final long serialVersionUID = 552892318L;

  public static final int FIELD = 40304;
  ...
  public LegPaymentStreamResetDateBusinessDayConvention(Integer data) {
    super(40304, data);
  }

  public LegPaymentStreamResetDateBusinessDayConvention(int data) {
    super(40304, data);
  }
}
