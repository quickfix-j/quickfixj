...
public class PaymentScheduleInterimExchangeDatesBusinessDayConvention extends IntField {
  static final long serialVersionUID = 552892318L;

  public static final int FIELD = 40862;
  ...
  public PaymentScheduleInterimExchangeDatesBusinessDayConvention(Integer data) {
    super(40862, data);
  }

  public PaymentScheduleInterimExchangeDatesBusinessDayConvention(int data) {
    super(40862, data);
  }
}
