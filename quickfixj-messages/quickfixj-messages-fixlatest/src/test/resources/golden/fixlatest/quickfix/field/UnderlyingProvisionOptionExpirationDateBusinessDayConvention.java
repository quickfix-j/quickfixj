...
public class UnderlyingProvisionOptionExpirationDateBusinessDayConvention extends IntField {
  static final long serialVersionUID = 552892318L;

  public static final int FIELD = 42134;
  ...
  public UnderlyingProvisionOptionExpirationDateBusinessDayConvention(Integer data) {
    super(42134, data);
  }

  public UnderlyingProvisionOptionExpirationDateBusinessDayConvention(int data) {
    super(42134, data);
  }
}
