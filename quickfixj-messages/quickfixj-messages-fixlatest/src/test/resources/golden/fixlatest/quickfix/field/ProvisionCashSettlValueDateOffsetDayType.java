...
public class ProvisionCashSettlValueDateOffsetDayType extends IntField {
  static final long serialVersionUID = 552892318L;

  public static final int FIELD = 40121;
  ...
  public ProvisionCashSettlValueDateOffsetDayType(Integer data) {
    super(40121, data);
  }

  public ProvisionCashSettlValueDateOffsetDayType(int data) {
    super(40121, data);
  }
}
