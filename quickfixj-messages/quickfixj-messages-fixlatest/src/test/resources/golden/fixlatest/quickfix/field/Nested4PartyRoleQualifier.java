...
public class Nested4PartyRoleQualifier extends IntField {
  static final long serialVersionUID = 552892318L;

  public static final int FIELD = 2383;
  ...
  public Nested4PartyRoleQualifier(Integer data) {
    super(2383, data);
  }

  public Nested4PartyRoleQualifier(int data) {
    super(2383, data);
  }
}
