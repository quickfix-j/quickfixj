...
public class LegProvisionPartyRoleQualifier extends IntField {
  static final long serialVersionUID = 552892318L;

  public static final int FIELD = 2380;
  ...
  public LegProvisionPartyRoleQualifier(Integer data) {
    super(2380, data);
  }

  public LegProvisionPartyRoleQualifier(int data) {
    super(2380, data);
  }
}
