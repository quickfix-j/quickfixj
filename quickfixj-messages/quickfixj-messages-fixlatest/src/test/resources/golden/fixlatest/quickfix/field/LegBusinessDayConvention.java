...
public class LegBusinessDayConvention extends IntField {
  static final long serialVersionUID = 552892318L;

  public static final int FIELD = 40925;
  ...
  public LegBusinessDayConvention(Integer data) {
    super(40925, data);
  }

  public LegBusinessDayConvention(int data) {
    super(40925, data);
  }
}
