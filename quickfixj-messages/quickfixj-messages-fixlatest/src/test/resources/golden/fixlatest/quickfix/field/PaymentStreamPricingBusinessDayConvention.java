...
public class PaymentStreamPricingBusinessDayConvention extends IntField {
  static final long serialVersionUID = 552892318L;

  public static final int FIELD = 41217;
  ...
  public PaymentStreamPricingBusinessDayConvention(Integer data) {
    super(41217, data);
  }

  public PaymentStreamPricingBusinessDayConvention(int data) {
    super(41217, data);
  }
}
