...
public class SettlMethodElectionDateOffsetDayType extends IntField {
  static final long serialVersionUID = 552892318L;

  public static final int FIELD = 42782;
  ...
  public SettlMethodElectionDateOffsetDayType(Integer data) {
    super(42782, data);
  }

  public SettlMethodElectionDateOffsetDayType(int data) {
    super(42782, data);
  }
}
