...
public class CollateralReportAck extends Message {
  static final long serialVersionUID = 552892318L;

  public static final String MSGTYPE = "DQ";

  public CollateralReportAck() {
    super();
    getHeader().setField(new quickfix.field.MsgType(MSGTYPE));
  }

  public CollateralReportAck (quickfix.field.CollRptID collRptID, quickfix.field.CollRptStatus collRptStatus) {
    this();
    setField(collRptID);
    setField(collRptStatus);
  }
  ...
  public void set(quickfix.field.CollRptStatus value) {
    setField(value);
  }

  public quickfix.field.CollRptStatus get(quickfix.field.CollRptStatus value) throws FieldNotFound {
    getField(value);
    return value;
  }

  public quickfix.field.CollRptStatus getCollRptStatus() throws FieldNotFound {
    return get(new quickfix.field.CollRptStatus());
  }

  public boolean isSet(quickfix.field.CollRptStatus field) {
    return isSetField(field);
  }

  public boolean isSetCollRptStatus() {
    return isSetField(2488);
  }

  public void set(quickfix.field.CollRptRejectReason value) {
    setField(value);
  }

  public quickfix.field.CollRptRejectReason get(quickfix.field.CollRptRejectReason value) throws FieldNotFound {
    getField(value);
    return value;
  }

  public quickfix.field.CollRptRejectReason getCollRptRejectReason() throws FieldNotFound {
    return get(new quickfix.field.CollRptRejectReason());
  }

  public boolean isSet(quickfix.field.CollRptRejectReason field) {
    return isSetField(field);
  }

  public boolean isSetCollRptRejectReason() {
    return isSetField(2487);
  }
