...
public class InstrumentScopeProduct extends IntField {
  static final long serialVersionUID = 552892318L;

  public static final int FIELD = 1543;
  ...
  public InstrumentScopeProduct(Integer data) {
    super(1543, data);
  }

  public InstrumentScopeProduct(int data) {
    super(1543, data);
  }
}
