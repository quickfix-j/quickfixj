...
public class PartyRoleQualifier extends IntField {
  static final long serialVersionUID = 552892318L;

  public static final int FIELD = 2376;
  ...
  public PartyRoleQualifier(Integer data) {
    super(2376, data);
  }

  public PartyRoleQualifier(int data) {
    super(2376, data);
  }
}
