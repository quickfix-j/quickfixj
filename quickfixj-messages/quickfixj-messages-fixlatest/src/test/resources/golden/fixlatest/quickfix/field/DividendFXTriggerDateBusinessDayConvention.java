...
public class DividendFXTriggerDateBusinessDayConvention extends IntField {
  static final long serialVersionUID = 552892318L;

  public static final int FIELD = 42270;
  ...
  public DividendFXTriggerDateBusinessDayConvention(Integer data) {
    super(42270, data);
  }

  public DividendFXTriggerDateBusinessDayConvention(int data) {
    super(42270, data);
  }
}
