...
public class LegOptionExerciseBusinessDayConvention extends IntField {
  static final long serialVersionUID = 552892318L;

  public static final int FIELD = 41493;
  ...
  public LegOptionExerciseBusinessDayConvention(Integer data) {
    super(41493, data);
  }

  public LegOptionExerciseBusinessDayConvention(int data) {
    super(41493, data);
  }
}
