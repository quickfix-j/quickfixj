...
public class LegInstrumentPartyRole extends IntField {
  static final long serialVersionUID = 552892318L;

  public static final int FIELD = 2257;
  ...
  public LegInstrumentPartyRole(Integer data) {
    super(2257, data);
  }

  public LegInstrumentPartyRole(int data) {
    super(2257, data);
  }
}
