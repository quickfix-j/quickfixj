...
public class MarketDataIncrementalRefresh extends Message {
  ...
  public void set(quickfix.fixlatest.component.MDIncGrp component) {
    setComponent(component);
  }

  public quickfix.fixlatest.component.MDIncGrp get(quickfix.fixlatest.component.MDIncGrp component) throws FieldNotFound {
    getComponent(component);
    return component;
  }

  public quickfix.fixlatest.component.MDIncGrp getMDIncGrpComponent() throws FieldNotFound {
    return get(new quickfix.fixlatest.component.MDIncGrp());
  }
