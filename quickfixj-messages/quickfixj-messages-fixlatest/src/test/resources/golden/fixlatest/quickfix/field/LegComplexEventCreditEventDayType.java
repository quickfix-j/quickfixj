...
public class LegComplexEventCreditEventDayType extends IntField {
  static final long serialVersionUID = 552892318L;

  public static final int FIELD = 41372;
  ...
  public LegComplexEventCreditEventDayType(Integer data) {
    super(41372, data);
  }

  public LegComplexEventCreditEventDayType(int data) {
    super(41372, data);
  }
}
