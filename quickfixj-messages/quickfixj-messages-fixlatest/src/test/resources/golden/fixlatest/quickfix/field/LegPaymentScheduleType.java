...
public class LegPaymentScheduleType extends IntField {
  static final long serialVersionUID = 552892318L;

  public static final int FIELD = 40375;
  ...
  public LegPaymentScheduleType(Integer data) {
    super(40375, data);
  }

  public LegPaymentScheduleType(int data) {
    super(40375, data);
  }
}
