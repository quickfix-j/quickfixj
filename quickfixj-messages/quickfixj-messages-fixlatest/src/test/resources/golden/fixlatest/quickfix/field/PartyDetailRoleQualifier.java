...
public class PartyDetailRoleQualifier extends IntField {
  static final long serialVersionUID = 552892318L;

  public static final int FIELD = 1674;
  ...
  public PartyDetailRoleQualifier(Integer data) {
    super(1674, data);
  }

  public PartyDetailRoleQualifier(int data) {
    super(1674, data);
  }
}
