...
public class PartyEntitlementsUpdateReport extends Message {
  static final long serialVersionUID = 552892318L;

  public static final String MSGTYPE = "CZ";

  public PartyEntitlementsUpdateReport() {
    super();
    getHeader().setField(new quickfix.field.MsgType(MSGTYPE));
  }

  public PartyEntitlementsUpdateReport (quickfix.field.EntitlementReportID entitlementReportID) {
    this();
...
public static class NoRequestingPartySubIDs extends Group {
  ...
  public void set(quickfix.fixlatest.component.PartyEntitlementUpdateGrp component) {
    setComponent(component);
  }

  public quickfix.fixlatest.component.PartyEntitlementUpdateGrp get(quickfix.fixlatest.component.PartyEntitlementUpdateGrp component) throws FieldNotFound {
    getComponent(component);
    return component;
  }

  public quickfix.fixlatest.component.PartyEntitlementUpdateGrp getPartyEntitlementUpdateGrpComponent() throws FieldNotFound {
    return get(new quickfix.fixlatest.component.PartyEntitlementUpdateGrp());
  }
...
public static class NoPartyEntitlements extends Group {
  static final long serialVersionUID = 552892318L;
  private static final int[]  ORDER = {1324, 1671, 1883, 1773, 1885, 0};
