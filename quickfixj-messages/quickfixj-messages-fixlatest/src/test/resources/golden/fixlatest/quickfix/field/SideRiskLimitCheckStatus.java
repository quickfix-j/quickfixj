...
public class SideRiskLimitCheckStatus extends IntField {
  static final long serialVersionUID = 552892318L;

  public static final int FIELD = 2344;
  ...
  public SideRiskLimitCheckStatus(Integer data) {
    super(2344, data);
  }

  public SideRiskLimitCheckStatus(int data) {
    super(2344, data);
  }
}
