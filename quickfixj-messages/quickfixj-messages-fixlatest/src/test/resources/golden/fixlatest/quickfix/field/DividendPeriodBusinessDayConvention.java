...
public class DividendPeriodBusinessDayConvention extends IntField {
  static final long serialVersionUID = 552892318L;

  public static final int FIELD = 42280;
  ...
  public DividendPeriodBusinessDayConvention(Integer data) {
    super(42280, data);
  }

  public DividendPeriodBusinessDayConvention(int data) {
    super(42280, data);
  }
}
