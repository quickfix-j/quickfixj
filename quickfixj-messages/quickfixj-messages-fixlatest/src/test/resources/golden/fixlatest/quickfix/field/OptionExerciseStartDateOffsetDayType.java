...
public class OptionExerciseStartDateOffsetDayType extends IntField {
  static final long serialVersionUID = 552892318L;

  public static final int FIELD = 41128;
  ...
  public OptionExerciseStartDateOffsetDayType(Integer data) {
    super(41128, data);
  }

  public OptionExerciseStartDateOffsetDayType(int data) {
    super(41128, data);
  }
}
