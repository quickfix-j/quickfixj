...
public class RiskLimitCheckStatus extends IntField {
  static final long serialVersionUID = 552892318L;

  public static final int FIELD = 2343;
  ...
  public RiskLimitCheckStatus(Integer data) {
    super(2343, data);
  }

  public RiskLimitCheckStatus(int data) {
    super(2343, data);
  }
}
