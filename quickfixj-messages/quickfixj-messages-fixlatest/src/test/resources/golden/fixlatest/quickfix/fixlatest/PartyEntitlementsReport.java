...
public class PartyEntitlementsReport extends Message {
  static final long serialVersionUID = 552892318L;

  public static final String MSGTYPE = "CV";
  ...
  public PartyEntitlementsReport (quickfix.field.EntitlementReportID entitlementReportID) {
    this();
    setField(entitlementReportID);
  }
  ...
  public void set(quickfix.field.EntitlementReportID value) {
    setField(value);
  }

  public quickfix.field.EntitlementReportID get(quickfix.field.EntitlementReportID value) throws FieldNotFound {
    getField(value);
    return value;
  }

  public quickfix.field.EntitlementReportID getEntitlementReportID() throws FieldNotFound {
    return get(new quickfix.field.EntitlementReportID());
  }

  public boolean isSet(quickfix.field.EntitlementReportID field) {
    return isSetField(field);
  }

  public boolean isSetEntitlementReportID() {
    return isSetField(1771);
  }
  ...
  public void set(quickfix.fixlatest.component.PartyEntitlementGrp component) {
    setComponent(component);
  }

  public quickfix.fixlatest.component.PartyEntitlementGrp get(quickfix.fixlatest.component.PartyEntitlementGrp component) throws FieldNotFound {
    getComponent(component);
    return component;
  }

  public quickfix.fixlatest.component.PartyEntitlementGrp getPartyEntitlementGrpComponent() throws FieldNotFound {
    return get(new quickfix.fixlatest.component.PartyEntitlementGrp());
  }
...
public static class NoPartyEntitlements extends Group {
  static final long serialVersionUID = 552892318L;
  private static final int[]  ORDER = {1671, 1883, 1773, 0};
