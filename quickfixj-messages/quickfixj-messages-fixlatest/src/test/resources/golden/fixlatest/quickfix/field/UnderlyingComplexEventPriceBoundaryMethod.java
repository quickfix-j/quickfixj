...
public class UnderlyingComplexEventPriceBoundaryMethod extends IntField {
  static final long serialVersionUID = 552892318L;

  public static final int FIELD = 2049;
  ...
  public UnderlyingComplexEventPriceBoundaryMethod(Integer data) {
    super(2049, data);
  }

  public UnderlyingComplexEventPriceBoundaryMethod(int data) {
    super(2049, data);
  }
}
