...
public class UnderlyingProvisionPartyRole extends IntField {
  static final long serialVersionUID = 552892318L;

  public static final int FIELD = 42176;
  ...
  public UnderlyingProvisionPartyRole(Integer data) {
    super(42176, data);
  }

  public UnderlyingProvisionPartyRole(int data) {
    super(42176, data);
  }
}
