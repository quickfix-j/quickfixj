...
public class DerivativeSecurityList extends Message {
  ...
  public void set(quickfix.fixlatest.component.RelSymDerivSecGrp component) {
    setComponent(component);
  }

  public quickfix.fixlatest.component.RelSymDerivSecGrp get(quickfix.fixlatest.component.RelSymDerivSecGrp component) throws FieldNotFound {
    getComponent(component);
    return component;
  }

  public quickfix.fixlatest.component.RelSymDerivSecGrp getRelSymDerivSecGrpComponent() throws FieldNotFound {
    return get(new quickfix.fixlatest.component.RelSymDerivSecGrp());
  }
