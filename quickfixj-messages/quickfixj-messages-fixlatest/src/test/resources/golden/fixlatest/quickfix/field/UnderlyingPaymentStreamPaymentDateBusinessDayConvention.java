...
public class UnderlyingPaymentStreamPaymentDateBusinessDayConvention extends IntField {
  static final long serialVersionUID = 552892318L;

  public static final int FIELD = 40581;
  ...
  public UnderlyingPaymentStreamPaymentDateBusinessDayConvention(Integer data) {
    super(40581, data);
  }

  public UnderlyingPaymentStreamPaymentDateBusinessDayConvention(int data) {
    super(40581, data);
  }
}
