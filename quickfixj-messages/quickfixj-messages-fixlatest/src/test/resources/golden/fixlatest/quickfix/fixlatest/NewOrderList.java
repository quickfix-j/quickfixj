...
public class NewOrderList extends Message {
  ...
  public void set(quickfix.field.ListManualOrderIndicator value) {
    setField(value);
  }

  public quickfix.field.ListManualOrderIndicator get(quickfix.field.ListManualOrderIndicator value) throws FieldNotFound {
    getField(value);
    return value;
  }

  public quickfix.field.ListManualOrderIndicator getListManualOrderIndicator() throws FieldNotFound {
    return get(new quickfix.field.ListManualOrderIndicator());
  }

  public boolean isSet(quickfix.field.ListManualOrderIndicator field) {
    return isSetField(field);
  }

  public boolean isSetListManualOrderIndicator() {
    return isSetField(2401);
  }
...
public static class NoRootPartySubIDs extends Group {
  ...
  public void set(quickfix.fixlatest.component.ListOrdGrp component) {
    setComponent(component);
  }

  public quickfix.fixlatest.component.ListOrdGrp get(quickfix.fixlatest.component.ListOrdGrp component) throws FieldNotFound {
    getComponent(component);
    return component;
  }

  public quickfix.fixlatest.component.ListOrdGrp getListOrdGrpComponent() throws FieldNotFound {
    return get(new quickfix.fixlatest.component.ListOrdGrp());
  }
