...
public class LegStreamCalculationPeriodBusinessDayConvention extends IntField {
  static final long serialVersionUID = 552892318L;

  public static final int FIELD = 40265;
  ...
  public LegStreamCalculationPeriodBusinessDayConvention(Integer data) {
    super(40265, data);
  }

  public LegStreamCalculationPeriodBusinessDayConvention(int data) {
    super(40265, data);
  }
}
