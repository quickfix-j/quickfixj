...
public class LegProvisionOptionExerciseBusinessDayConvention extends IntField {
  static final long serialVersionUID = 552892318L;

  public static final int FIELD = 40476;
  ...
  public LegProvisionOptionExerciseBusinessDayConvention(Integer data) {
    super(40476, data);
  }

  public LegProvisionOptionExerciseBusinessDayConvention(int data) {
    super(40476, data);
  }
}
