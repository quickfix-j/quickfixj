...
public class StreamFirstPeriodStartDateBusinessDayConvention extends IntField {
  static final long serialVersionUID = 552892318L;

  public static final int FIELD = 40076;
  ...
  public StreamFirstPeriodStartDateBusinessDayConvention(Integer data) {
    super(40076, data);
  }

  public StreamFirstPeriodStartDateBusinessDayConvention(int data) {
    super(40076, data);
  }
}
