...
public class RootPartyRoleQualifier extends IntField {
  static final long serialVersionUID = 552892318L;

  public static final int FIELD = 2388;
  ...
  public RootPartyRoleQualifier(Integer data) {
    super(2388, data);
  }

  public RootPartyRoleQualifier(int data) {
    super(2388, data);
  }
}
