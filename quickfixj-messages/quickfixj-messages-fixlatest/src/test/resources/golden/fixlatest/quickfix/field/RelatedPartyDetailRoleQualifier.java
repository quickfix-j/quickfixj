...
public class RelatedPartyDetailRoleQualifier extends IntField {
  static final long serialVersionUID = 552892318L;

  public static final int FIELD = 1675;
  ...
  public RelatedPartyDetailRoleQualifier(Integer data) {
    super(1675, data);
  }

  public RelatedPartyDetailRoleQualifier(int data) {
    super(1675, data);
  }
}
