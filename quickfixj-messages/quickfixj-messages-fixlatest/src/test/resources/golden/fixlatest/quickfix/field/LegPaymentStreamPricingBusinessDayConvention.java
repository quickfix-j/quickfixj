...
public class LegPaymentStreamPricingBusinessDayConvention extends IntField {
  static final long serialVersionUID = 552892318L;

  public static final int FIELD = 41586;
  ...
  public LegPaymentStreamPricingBusinessDayConvention(Integer data) {
    super(41586, data);
  }

  public LegPaymentStreamPricingBusinessDayConvention(int data) {
    super(41586, data);
  }
}
