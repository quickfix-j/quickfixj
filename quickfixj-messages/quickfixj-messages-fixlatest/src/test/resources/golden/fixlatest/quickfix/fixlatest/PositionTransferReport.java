...
public class PositionTransferReport extends Message {
  ...
  public static final String MSGTYPE = "DN";
  ...
  public PositionTransferReport (quickfix.field.TransferReportID transferReportID, quickfix.field.TransferID transferID, quickfix.field.TransferTransType transferTransType, quickfix.field.TransferReportType transferReportType, quickfix.field.TransferStatus transferStatus) {
    this();
    setField(transferReportID);
    setField(transferID);
    setField(transferTransType);
    setField(transferReportType);
    setField(transferStatus);
  }
  ...
  public void set(quickfix.field.TransferReportID value) {
    setField(value);
  }

  public quickfix.field.TransferReportID get(quickfix.field.TransferReportID value) throws FieldNotFound {
    getField(value);
    return value;
  }

  public quickfix.field.TransferReportID getTransferReportID() throws FieldNotFound {
    return get(new quickfix.field.TransferReportID());
  }

  public boolean isSet(quickfix.field.TransferReportID field) {
    return isSetField(field);
  }

  public boolean isSetTransferReportID() {
    return isSetField(2438);
  }
  ...
  public void set(quickfix.field.TransferReportType value) {
    setField(value);
  }

  public quickfix.field.TransferReportType get(quickfix.field.TransferReportType value) throws FieldNotFound {
    getField(value);
    return value;
  }

  public quickfix.field.TransferReportType getTransferReportType() throws FieldNotFound {
    return get(new quickfix.field.TransferReportType());
  }

  public boolean isSet(quickfix.field.TransferReportType field) {
    return isSetField(field);
  }

  public boolean isSetTransferReportType() {
    return isSetField(2444);
  }
