...
public class PartyDetailsDefinitionRequestAck extends Message {
  static final long serialVersionUID = 552892318L;

  public static final String MSGTYPE = "CY";

  public PartyDetailsDefinitionRequestAck() {
    super();
    getHeader().setField(new quickfix.field.MsgType(MSGTYPE));
  }

  public PartyDetailsDefinitionRequestAck (quickfix.field.PartyDetailsListRequestID partyDetailsListRequestID, quickfix.field.PartyDetailRequestStatus partyDetailRequestStatus) {
    this();
    setField(partyDetailsListRequestID);
    setField(partyDetailRequestStatus);
  }
  ...
  public void set(quickfix.field.PartyDetailRequestStatus value) {
    setField(value);
  }

  public quickfix.field.PartyDetailRequestStatus get(quickfix.field.PartyDetailRequestStatus value) throws FieldNotFound {
    getField(value);
    return value;
  }

  public quickfix.field.PartyDetailRequestStatus getPartyDetailRequestStatus() throws FieldNotFound {
    return get(new quickfix.field.PartyDetailRequestStatus());
  }

  public boolean isSet(quickfix.field.PartyDetailRequestStatus field) {
    return isSetField(field);
  }

  public boolean isSetPartyDetailRequestStatus() {
    return isSetField(1878);
  }

  public void set(quickfix.field.PartyDetailRequestResult value) {
    setField(value);
  }

  public quickfix.field.PartyDetailRequestResult get(quickfix.field.PartyDetailRequestResult value) throws FieldNotFound {
    getField(value);
    return value;
  }

  public quickfix.field.PartyDetailRequestResult getPartyDetailRequestResult() throws FieldNotFound {
    return get(new quickfix.field.PartyDetailRequestResult());
  }

  public boolean isSet(quickfix.field.PartyDetailRequestResult field) {
    return isSetField(field);
  }

  public boolean isSetPartyDetailRequestResult() {
    return isSetField(1877);
  }
...
public static class NoRequestingPartySubIDs extends Group {
  ...
  public void set(quickfix.fixlatest.component.PartyDetailAckGrp component) {
    setComponent(component);
  }

  public quickfix.fixlatest.component.PartyDetailAckGrp get(quickfix.fixlatest.component.PartyDetailAckGrp component) throws FieldNotFound {
    getComponent(component);
    return component;
  }

  public quickfix.fixlatest.component.PartyDetailAckGrp getPartyDetailAckGrpComponent() throws FieldNotFound {
    return get(new quickfix.fixlatest.component.PartyDetailAckGrp());
  }
