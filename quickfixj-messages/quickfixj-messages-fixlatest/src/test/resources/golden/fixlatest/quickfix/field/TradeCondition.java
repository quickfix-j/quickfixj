...
public class TradeCondition extends StringField {
  ...
  public static final String TRADES_RESULTING_FROM_MANUAL = "Y";
  ...
  public static final String CROSSED_OLD = "AO";
  ...
  public static final String TRADE_THROUGH_EXEMPT = "AU";

  public static final String QUOTE_SPREAD = "AV";

  public static final String LAST_AUCTION_PRICE = "AW";

  public static final String HIGH_PRICE = "AX";

  public static final String LOW_PRICE = "AY";

  public static final String SYSTEMATIC_INTERNALISER = "AZ";

  public static final String AWAY_MARKET = "BA";

  public static final String MIDPOINT_PRICE = "BB";

  public static final String TRADED_BEFORE_ISSUE_DATE = "BC";

  public static final String PREVIOUS_CLOSING_PRICE = "BD";

  public static final String NATIONAL_BEST_BID_OFFER = "BE";

  public static final String IMPLIED_TRADE = "1";

  public static final String MARKETPLACE_ENTERED_TRADE = "2";

  public static final String MULTI_ASSET_CLASS_MULTILEG_TRADE = "3";

  public static final String MULTILEG_TO_MULTILEG_TRADE = "4";

  public static final String SHORT_SALE_MIN_PRICE = "5";
