...
public class ProvisionOptionExerciseBusinessDayConvention extends IntField {
  static final long serialVersionUID = 552892318L;

  public static final int FIELD = 40123;
  ...
  public ProvisionOptionExerciseBusinessDayConvention(Integer data) {
    super(40123, data);
  }

  public ProvisionOptionExerciseBusinessDayConvention(int data) {
    super(40123, data);
  }
}
