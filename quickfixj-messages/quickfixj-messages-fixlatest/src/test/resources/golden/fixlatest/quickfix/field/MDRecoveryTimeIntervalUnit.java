...
public class MDRecoveryTimeIntervalUnit extends IntField {
  static final long serialVersionUID = 552892318L;

  public static final int FIELD = 2566;
  ...
  public MDRecoveryTimeIntervalUnit(Integer data) {
    super(2566, data);
  }

  public MDRecoveryTimeIntervalUnit(int data) {
    super(2566, data);
  }
}
