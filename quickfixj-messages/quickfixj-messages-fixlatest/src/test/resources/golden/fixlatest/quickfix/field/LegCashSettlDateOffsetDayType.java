...
public class LegCashSettlDateOffsetDayType extends IntField {
  static final long serialVersionUID = 552892318L;

  public static final int FIELD = 42304;
  ...
  public LegCashSettlDateOffsetDayType(Integer data) {
    super(42304, data);
  }

  public LegCashSettlDateOffsetDayType(int data) {
    super(42304, data);
  }
}
