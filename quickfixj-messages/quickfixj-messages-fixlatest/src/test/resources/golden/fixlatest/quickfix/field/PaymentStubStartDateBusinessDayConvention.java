...
public class PaymentStubStartDateBusinessDayConvention extends IntField {
  static final long serialVersionUID = 552892318L;

  public static final int FIELD = 42699;
  ...
  public PaymentStubStartDateBusinessDayConvention(Integer data) {
    super(42699, data);
  }

  public PaymentStubStartDateBusinessDayConvention(int data) {
    super(42699, data);
  }
}
