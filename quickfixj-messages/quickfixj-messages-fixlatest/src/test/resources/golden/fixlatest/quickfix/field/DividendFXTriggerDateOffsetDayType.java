...
public class DividendFXTriggerDateOffsetDayType extends IntField {
  static final long serialVersionUID = 552892318L;

  public static final int FIELD = 42268;
  ...
  public DividendFXTriggerDateOffsetDayType(Integer data) {
    super(42268, data);
  }

  public DividendFXTriggerDateOffsetDayType(int data) {
    super(42268, data);
  }
}
