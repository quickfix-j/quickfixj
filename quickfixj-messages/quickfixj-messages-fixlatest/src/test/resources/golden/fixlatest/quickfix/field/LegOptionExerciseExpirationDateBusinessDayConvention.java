...
public class LegOptionExerciseExpirationDateBusinessDayConvention extends IntField {
  static final long serialVersionUID = 552892318L;

  public static final int FIELD = 41517;
  ...
  public LegOptionExerciseExpirationDateBusinessDayConvention(Integer data) {
    super(41517, data);
  }

  public LegOptionExerciseExpirationDateBusinessDayConvention(int data) {
    super(41517, data);
  }
}
