...
public class LegProvisionPartyRole extends IntField {
  static final long serialVersionUID = 552892318L;

  public static final int FIELD = 40536;
  ...
  public LegProvisionPartyRole(Integer data) {
    super(40536, data);
  }

  public LegProvisionPartyRole(int data) {
    super(40536, data);
  }
}
