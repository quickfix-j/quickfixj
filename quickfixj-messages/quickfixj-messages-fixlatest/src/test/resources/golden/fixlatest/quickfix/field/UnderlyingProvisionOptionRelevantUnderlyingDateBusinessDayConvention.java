...
public class UnderlyingProvisionOptionRelevantUnderlyingDateBusinessDayConvention extends IntField {
  static final long serialVersionUID = 552892318L;

  public static final int FIELD = 42143;
  ...
  public UnderlyingProvisionOptionRelevantUnderlyingDateBusinessDayConvention(Integer data) {
    super(42143, data);
  }

  public UnderlyingProvisionOptionRelevantUnderlyingDateBusinessDayConvention(int data) {
    super(42143, data);
  }
}
