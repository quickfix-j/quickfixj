...
public class MDStatisticFrequencyUnit extends IntField {
  static final long serialVersionUID = 552892318L;

  public static final int FIELD = 2461;
  ...
  public MDStatisticFrequencyUnit(Integer data) {
    super(2461, data);
  }

  public MDStatisticFrequencyUnit(int data) {
    super(2461, data);
  }
}
