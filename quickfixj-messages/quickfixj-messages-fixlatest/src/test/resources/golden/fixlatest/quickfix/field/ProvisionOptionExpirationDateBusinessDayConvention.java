...
public class ProvisionOptionExpirationDateBusinessDayConvention extends IntField {
  static final long serialVersionUID = 552892318L;

  public static final int FIELD = 40146;
  ...
  public ProvisionOptionExpirationDateBusinessDayConvention(Integer data) {
    super(40146, data);
  }

  public ProvisionOptionExpirationDateBusinessDayConvention(int data) {
    super(40146, data);
  }
}
