...
public class LegComplexOptPayoutTime extends IntField {
  static final long serialVersionUID = 552892318L;

  public static final int FIELD = 2225;
  ...
  public LegComplexOptPayoutTime(Integer data) {
    super(2225, data);
  }

  public LegComplexOptPayoutTime(int data) {
    super(2225, data);
  }
}
