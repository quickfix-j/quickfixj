...
public class MassQuoteAck extends Message {
  ...
  public MassQuoteAck (quickfix.field.QuoteStatus quoteStatus) {
    this();
...
public static class NoTargetPartySubIDs extends Group {
  ...
  public void set(quickfix.fixlatest.component.QuotSetAckGrp component) {
    setComponent(component);
  }

  public quickfix.fixlatest.component.QuotSetAckGrp get(quickfix.fixlatest.component.QuotSetAckGrp component) throws FieldNotFound {
    getComponent(component);
    return component;
  }

  public quickfix.fixlatest.component.QuotSetAckGrp getQuotSetAckGrpComponent() throws FieldNotFound {
    return get(new quickfix.fixlatest.component.QuotSetAckGrp());
  }
...
public static class NoQuoteSets extends Group {
  ...
  public void set(quickfix.field.TotNoCxldQuotes value) {
    setField(value);
  }

  public quickfix.field.TotNoCxldQuotes get(quickfix.field.TotNoCxldQuotes value) throws FieldNotFound {
    getField(value);
    return value;
  }

  public quickfix.field.TotNoCxldQuotes getTotNoCxldQuotes() throws FieldNotFound {
    return get(new quickfix.field.TotNoCxldQuotes());
  }

  public boolean isSet(quickfix.field.TotNoCxldQuotes field) {
    return isSetField(field);
  }

  public boolean isSetTotNoCxldQuotes() {
    return isSetField(1168);
  }

  public void set(quickfix.field.TotNoAccQuotes value) {
    setField(value);
  }

  public quickfix.field.TotNoAccQuotes get(quickfix.field.TotNoAccQuotes value) throws FieldNotFound {
    getField(value);
    return value;
  }

  public quickfix.field.TotNoAccQuotes getTotNoAccQuotes() throws FieldNotFound {
    return get(new quickfix.field.TotNoAccQuotes());
  }

  public boolean isSet(quickfix.field.TotNoAccQuotes field) {
    return isSetField(field);
  }

  public boolean isSetTotNoAccQuotes() {
    return isSetField(1169);
  }

  public void set(quickfix.field.TotNoRejQuotes value) {
    setField(value);
  }

  public quickfix.field.TotNoRejQuotes get(quickfix.field.TotNoRejQuotes value) throws FieldNotFound {
    getField(value);
    return value;
  }

  public quickfix.field.TotNoRejQuotes getTotNoRejQuotes() throws FieldNotFound {
    return get(new quickfix.field.TotNoRejQuotes());
  }

  public boolean isSet(quickfix.field.TotNoRejQuotes field) {
    return isSetField(field);
  }

  public boolean isSetTotNoRejQuotes() {
    return isSetField(1170);
  }
  ...
  public void set(quickfix.fixlatest.component.QuotEntryAckGrp component) {
    setComponent(component);
  }

  public quickfix.fixlatest.component.QuotEntryAckGrp get(quickfix.fixlatest.component.QuotEntryAckGrp component) throws FieldNotFound {
    getComponent(component);
    return component;
  }

  public quickfix.fixlatest.component.QuotEntryAckGrp getQuotEntryAckGrpComponent() throws FieldNotFound {
    return get(new quickfix.fixlatest.component.QuotEntryAckGrp());
  }
