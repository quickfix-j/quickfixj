...
public class PaymentStreamPaymentDateBusinessDayConvention extends IntField {
  static final long serialVersionUID = 552892318L;

  public static final int FIELD = 40751;
  ...
  public PaymentStreamPaymentDateBusinessDayConvention(Integer data) {
    super(40751, data);
  }

  public PaymentStreamPaymentDateBusinessDayConvention(int data) {
    super(40751, data);
  }
}
