...
public class CollateralInquiry extends Message {
  ...
  public CollateralInquiry (quickfix.field.CollInquiryID collInquiryID) {
    this();
  ...
  public void set(quickfix.fixlatest.component.CollInqQualGrp component) {
    setComponent(component);
  }

  public quickfix.fixlatest.component.CollInqQualGrp get(quickfix.fixlatest.component.CollInqQualGrp component) throws FieldNotFound {
    getComponent(component);
    return component;
  }

  public quickfix.fixlatest.component.CollInqQualGrp getCollInqQualGrpComponent() throws FieldNotFound {
    return get(new quickfix.fixlatest.component.CollInqQualGrp());
  }
