...
public class ReturnRateValuationTimeType extends IntField {
  static final long serialVersionUID = 552892318L;

  public static final int FIELD = 42756;
  ...
  public ReturnRateValuationTimeType(Integer data) {
    super(42756, data);
  }

  public ReturnRateValuationTimeType(int data) {
    super(42756, data);
  }
}
