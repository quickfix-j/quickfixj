...
public class UnderlyingStipType extends StringField {
  ...
  public static final String AUTO_REINVESTMENT = "AUTOREINV";
  ...
  public static final String CUSTOM_START = "CUSTOMDATE";
  ...
  public static final String ISSUE_DATE = "ISSUE";
  ...
  public static final String PAYMENT_FREQUENCY = "PAYFREQ";
  ...
  public static final String ORIGINAL_AMOUNT = "ORIGAMT";

  public static final String POOL_EFFECTIVE_DATE = "POOLEFFDT";

  public static final String POOL_INITIAL_FACTOR = "POOLINITFCTR";
  ...
  public static final String INCURRED_RECOVERY = "INCURRCVY";

  public static final String ADDITIONAL_TERM = "ADDTRM";

  public static final String MODIFIED_EQUITY_DELIVERY = "MODEQTYDLVY";

  public static final String NO_REFERENCE_OBLICATION = "NOREFOBLIG";

  public static final String UNKNOWN_REFERENCE_OBLIGATION = "UNKREFOBLIG";

  public static final String ALL_GUARANTEES = "ALLGUARANTEES";

  public static final String REFERENCE_PRICE = "REFPX";

  public static final String REFERENCE_POLICY = "REFPOLICY";

  public static final String SECURED_LIST = "SECRDLIST";

  public static final String AVERAGE_FICOSCORE = "AVFICO";
  ...
  public static final String BROKER_CREDIT = "BROKERCREDIT";
  ...
  public static final String TRADER_CREDIT = "TRADERCREDIT";

  public static final String DISCOUNT_RATE = "DISCOUNT";

  public static final String YIELD_TO_MATURITY = "YTM";

  public static final String INTEREST_PAYOFF_OF_ROLLING_OR_AMENDING_TRADE = "PAYOFF";
