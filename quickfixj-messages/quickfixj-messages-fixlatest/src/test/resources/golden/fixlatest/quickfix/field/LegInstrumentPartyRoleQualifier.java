...
public class LegInstrumentPartyRoleQualifier extends IntField {
  static final long serialVersionUID = 552892318L;

  public static final int FIELD = 2379;
  ...
  public LegInstrumentPartyRoleQualifier(Integer data) {
    super(2379, data);
  }

  public LegInstrumentPartyRoleQualifier(int data) {
    super(2379, data);
  }
}
