...
public class UnderlyingPaymentStreamPricingBusinessDayConvention extends IntField {
  static final long serialVersionUID = 552892318L;

  public static final int FIELD = 41934;
  ...
  public UnderlyingPaymentStreamPricingBusinessDayConvention(Integer data) {
    super(41934, data);
  }

  public UnderlyingPaymentStreamPricingBusinessDayConvention(int data) {
    super(41934, data);
  }
}
