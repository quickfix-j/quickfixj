...
public class Nested3PartyRoleQualifier extends IntField {
  static final long serialVersionUID = 552892318L;

  public static final int FIELD = 2382;
  ...
  public Nested3PartyRoleQualifier(Integer data) {
    super(2382, data);
  }

  public Nested3PartyRoleQualifier(int data) {
    super(2382, data);
  }
}
