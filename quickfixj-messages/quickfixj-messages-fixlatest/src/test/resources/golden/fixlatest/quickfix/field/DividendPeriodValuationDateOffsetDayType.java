...
public class DividendPeriodValuationDateOffsetDayType extends IntField {
  static final long serialVersionUID = 552892318L;

  public static final int FIELD = 42285;
  ...
  public DividendPeriodValuationDateOffsetDayType(Integer data) {
    super(42285, data);
  }

  public DividendPeriodValuationDateOffsetDayType(int data) {
    super(42285, data);
  }
}
