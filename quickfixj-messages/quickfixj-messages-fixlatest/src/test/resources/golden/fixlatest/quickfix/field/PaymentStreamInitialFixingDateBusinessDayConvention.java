...
public class PaymentStreamInitialFixingDateBusinessDayConvention extends IntField {
  static final long serialVersionUID = 552892318L;

  public static final int FIELD = 40768;
  ...
  public PaymentStreamInitialFixingDateBusinessDayConvention(Integer data) {
    super(40768, data);
  }

  public PaymentStreamInitialFixingDateBusinessDayConvention(int data) {
    super(40768, data);
  }
}
