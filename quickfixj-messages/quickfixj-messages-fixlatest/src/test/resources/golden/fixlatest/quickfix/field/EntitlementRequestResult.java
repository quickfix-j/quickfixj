...
public class EntitlementRequestResult extends IntField {
  static final long serialVersionUID = 552892318L;

  public static final int FIELD = 1881;
  ...
  public EntitlementRequestResult(Integer data) {
    super(1881, data);
  }

  public EntitlementRequestResult(int data) {
    super(1881, data);
  }
}
