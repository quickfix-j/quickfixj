...
public class StreamEffectiveDateOffsetDayType extends IntField {
  static final long serialVersionUID = 552892318L;

  public static final int FIELD = 40913;
  ...
  public StreamEffectiveDateOffsetDayType(Integer data) {
    super(40913, data);
  }

  public StreamEffectiveDateOffsetDayType(int data) {
    super(40913, data);
  }
}
