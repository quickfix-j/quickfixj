...
public class PartyRiskLimitsUpdateReport extends Message {
  static final long serialVersionUID = 552892318L;

  public static final String MSGTYPE = "CR";

  public PartyRiskLimitsUpdateReport() {
    super();
    getHeader().setField(new quickfix.field.MsgType(MSGTYPE));
  }

  public PartyRiskLimitsUpdateReport (quickfix.field.RiskLimitReportID riskLimitReportID) {
    this();
