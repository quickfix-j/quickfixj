...
public class PaymentBusinessDayConvention extends IntField {
  static final long serialVersionUID = 552892318L;

  public static final int FIELD = 40220;
  ...
  public PaymentBusinessDayConvention(Integer data) {
    super(40220, data);
  }

  public PaymentBusinessDayConvention(int data) {
    super(40220, data);
  }
}
