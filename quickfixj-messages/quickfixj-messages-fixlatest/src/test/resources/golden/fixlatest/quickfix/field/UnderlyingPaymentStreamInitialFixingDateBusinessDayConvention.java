...
public class UnderlyingPaymentStreamInitialFixingDateBusinessDayConvention extends IntField {
  static final long serialVersionUID = 552892318L;

  public static final int FIELD = 40599;
  ...
  public UnderlyingPaymentStreamInitialFixingDateBusinessDayConvention(Integer data) {
    super(40599, data);
  }

  public UnderlyingPaymentStreamInitialFixingDateBusinessDayConvention(int data) {
    super(40599, data);
  }
}
