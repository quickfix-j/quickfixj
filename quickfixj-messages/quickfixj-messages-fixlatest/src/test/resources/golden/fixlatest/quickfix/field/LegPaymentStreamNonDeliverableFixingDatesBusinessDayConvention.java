...
public class LegPaymentStreamNonDeliverableFixingDatesBusinessDayConvention extends IntField {
  static final long serialVersionUID = 552892318L;

  public static final int FIELD = 40360;
  ...
  public LegPaymentStreamNonDeliverableFixingDatesBusinessDayConvention(Integer data) {
    super(40360, data);
  }

  public LegPaymentStreamNonDeliverableFixingDatesBusinessDayConvention(int data) {
    super(40360, data);
  }
}
