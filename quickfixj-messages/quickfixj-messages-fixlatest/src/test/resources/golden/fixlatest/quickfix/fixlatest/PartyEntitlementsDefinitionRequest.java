...
public class PartyEntitlementsDefinitionRequest extends Message {
  static final long serialVersionUID = 552892318L;

  public static final String MSGTYPE = "DA";

  public PartyEntitlementsDefinitionRequest() {
    super();
    getHeader().setField(new quickfix.field.MsgType(MSGTYPE));
  }

  public PartyEntitlementsDefinitionRequest (quickfix.field.EntitlementRequestID entitlementRequestID) {
    this();
