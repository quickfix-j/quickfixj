...
public class MDStatisticValueUnit extends IntField {
  static final long serialVersionUID = 552892318L;

  public static final int FIELD = 2480;
  ...
  public MDStatisticValueUnit(Integer data) {
    super(2480, data);
  }

  public MDStatisticValueUnit(int data) {
    super(2480, data);
  }
}
