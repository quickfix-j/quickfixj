...
public class UnderlyingOptionExerciseBusinessDayConvention extends IntField {
  static final long serialVersionUID = 552892318L;

  public static final int FIELD = 41822;
  ...
  public UnderlyingOptionExerciseBusinessDayConvention(Integer data) {
    super(41822, data);
  }

  public UnderlyingOptionExerciseBusinessDayConvention(int data) {
    super(41822, data);
  }
}
