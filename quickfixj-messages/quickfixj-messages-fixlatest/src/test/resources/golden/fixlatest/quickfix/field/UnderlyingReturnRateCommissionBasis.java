...
public class UnderlyingReturnRateCommissionBasis extends CharField {
  static final long serialVersionUID = 552892318L;

  public static final int FIELD = 43036;
  ...
  public UnderlyingReturnRateCommissionBasis(Character data) {
    super(43036, data);
  }

  public UnderlyingReturnRateCommissionBasis(char data) {
    super(43036, data);
  }
}
