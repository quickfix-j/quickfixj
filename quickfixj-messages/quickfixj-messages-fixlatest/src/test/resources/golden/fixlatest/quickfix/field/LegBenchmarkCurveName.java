...
public class LegBenchmarkCurveName extends StringField {
  ...
  public static final String FUTURE_SWAP = "FutureSWAP";

  public static final String LIBID = "LIBID";

  public static final String LIBOR = "LIBOR";

  public static final String MUNI_AAA = "MuniAAA";
  ...
  public static final String FED_FUND_RATE_EFFECTIVE = "FEDEFF";

  public static final String FED_OPEN = "FEDOPEN";
