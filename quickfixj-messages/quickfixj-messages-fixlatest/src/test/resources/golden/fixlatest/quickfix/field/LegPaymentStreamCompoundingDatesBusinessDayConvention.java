...
public class LegPaymentStreamCompoundingDatesBusinessDayConvention extends IntField {
  static final long serialVersionUID = 552892318L;

  public static final int FIELD = 42408;
  ...
  public LegPaymentStreamCompoundingDatesBusinessDayConvention(Integer data) {
    super(42408, data);
  }

  public LegPaymentStreamCompoundingDatesBusinessDayConvention(int data) {
    super(42408, data);
  }
}
