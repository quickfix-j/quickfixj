...
public class SecurityMassTradingStatus extends IntField {
  static final long serialVersionUID = 552892318L;

  public static final int FIELD = 1679;
  ...
  public SecurityMassTradingStatus(Integer data) {
    super(1679, data);
  }

  public SecurityMassTradingStatus(int data) {
    super(1679, data);
  }
}
