...
public class UnderlyingPaymentStreamNonDeliverableFixingDatesBusinessDayConvention extends IntField {
  static final long serialVersionUID = 552892318L;

  public static final int FIELD = 40649;
  ...
  public UnderlyingPaymentStreamNonDeliverableFixingDatesBusinessDayConvention(Integer data) {
    super(40649, data);
  }

  public UnderlyingPaymentStreamNonDeliverableFixingDatesBusinessDayConvention(int data) {
    super(40649, data);
  }
}
