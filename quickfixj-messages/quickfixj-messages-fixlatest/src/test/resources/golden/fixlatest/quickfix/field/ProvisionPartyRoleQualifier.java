...
public class ProvisionPartyRoleQualifier extends IntField {
  static final long serialVersionUID = 552892318L;

  public static final int FIELD = 2385;
  ...
  public ProvisionPartyRoleQualifier(Integer data) {
    super(2385, data);
  }

  public ProvisionPartyRoleQualifier(int data) {
    super(2385, data);
  }
}
