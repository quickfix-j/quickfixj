...
public class DividendPeriodPaymentDateOffsetDayType extends IntField {
  static final long serialVersionUID = 552892318L;

  public static final int FIELD = 42291;
  ...
  public DividendPeriodPaymentDateOffsetDayType(Integer data) {
    super(42291, data);
  }

  public DividendPeriodPaymentDateOffsetDayType(int data) {
    super(42291, data);
  }
}
