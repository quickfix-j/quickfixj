...
public class UnderlyingPaymentStubStartDateBusinessDayConvention extends IntField {
  static final long serialVersionUID = 552892318L;

  public static final int FIELD = 42994;
  ...
  public UnderlyingPaymentStubStartDateBusinessDayConvention(Integer data) {
    super(42994, data);
  }

  public UnderlyingPaymentStubStartDateBusinessDayConvention(int data) {
    super(42994, data);
  }
}
