...
public class PaymentStubEndDateBusinessDayConvention extends IntField {
  static final long serialVersionUID = 552892318L;

  public static final int FIELD = 42690;
  ...
  public PaymentStubEndDateBusinessDayConvention(Integer data) {
    super(42690, data);
  }

  public PaymentStubEndDateBusinessDayConvention(int data) {
    super(42690, data);
  }
}
