...
public class LegComplexEventType extends IntField {
  static final long serialVersionUID = 552892318L;

  public static final int FIELD = 2219;
  ...
  public LegComplexEventType(Integer data) {
    super(2219, data);
  }

  public LegComplexEventType(int data) {
    super(2219, data);
  }
}
