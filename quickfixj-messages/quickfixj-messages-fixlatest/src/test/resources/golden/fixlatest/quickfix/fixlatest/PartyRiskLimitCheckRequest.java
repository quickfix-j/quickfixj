...
public class PartyRiskLimitCheckRequest extends Message {
  static final long serialVersionUID = 552892318L;

  public static final String MSGTYPE = "DF";

  public PartyRiskLimitCheckRequest() {
    super();
    getHeader().setField(new quickfix.field.MsgType(MSGTYPE));
  }

  public PartyRiskLimitCheckRequest (quickfix.field.RiskLimitCheckTransType riskLimitCheckTransType, quickfix.field.RiskLimitCheckType riskLimitCheckType) {
    this();
  ...
  public void set(quickfix.field.RiskLimitCheckRequestType value) {
    setField(value);
  }

  public quickfix.field.RiskLimitCheckRequestType get(quickfix.field.RiskLimitCheckRequestType value) throws FieldNotFound {
    getField(value);
    return value;
  }

  public quickfix.field.RiskLimitCheckRequestType getRiskLimitCheckRequestType() throws FieldNotFound {
    return get(new quickfix.field.RiskLimitCheckRequestType());
  }

  public boolean isSet(quickfix.field.RiskLimitCheckRequestType field) {
    return isSetField(field);
  }

  public boolean isSetRiskLimitCheckRequestType() {
    return isSetField(2323);
  }
