...
public class StreamTerminationDateOffsetDayType extends IntField {
  static final long serialVersionUID = 552892318L;

  public static final int FIELD = 40071;
  ...
  public StreamTerminationDateOffsetDayType(Integer data) {
    super(40071, data);
  }

  public StreamTerminationDateOffsetDayType(int data) {
    super(40071, data);
  }
}
