...
public class UnderlyingStreamCommoditySettlDateBusinessDayConvention extends IntField {
  static final long serialVersionUID = 552892318L;

  public static final int FIELD = 41982;
  ...
  public UnderlyingStreamCommoditySettlDateBusinessDayConvention(Integer data) {
    super(41982, data);
  }

  public UnderlyingStreamCommoditySettlDateBusinessDayConvention(int data) {
    super(41982, data);
  }
}
