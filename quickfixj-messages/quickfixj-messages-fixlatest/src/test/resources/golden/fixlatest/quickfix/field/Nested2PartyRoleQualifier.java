...
public class Nested2PartyRoleQualifier extends IntField {
  static final long serialVersionUID = 552892318L;

  public static final int FIELD = 2381;
  ...
  public Nested2PartyRoleQualifier(Integer data) {
    super(2381, data);
  }

  public Nested2PartyRoleQualifier(int data) {
    super(2381, data);
  }
}
