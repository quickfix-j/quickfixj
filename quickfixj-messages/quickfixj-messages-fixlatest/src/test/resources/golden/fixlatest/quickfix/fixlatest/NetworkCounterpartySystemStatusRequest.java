...
public class NetworkCounterpartySystemStatusRequest extends Message {
  ...
  public void set(quickfix.fixlatest.component.CompIDReqGrp component) {
    setComponent(component);
  }

  public quickfix.fixlatest.component.CompIDReqGrp get(quickfix.fixlatest.component.CompIDReqGrp component) throws FieldNotFound {
    getComponent(component);
    return component;
  }

  public quickfix.fixlatest.component.CompIDReqGrp getCompIDReqGrpComponent() throws FieldNotFound {
    return get(new quickfix.fixlatest.component.CompIDReqGrp());
  }
