...
public class ComplexEventDateOffsetDayType extends IntField {
  static final long serialVersionUID = 552892318L;

  public static final int FIELD = 41024;
  ...
  public ComplexEventDateOffsetDayType(Integer data) {
    super(41024, data);
  }

  public ComplexEventDateOffsetDayType(int data) {
    super(41024, data);
  }
}
