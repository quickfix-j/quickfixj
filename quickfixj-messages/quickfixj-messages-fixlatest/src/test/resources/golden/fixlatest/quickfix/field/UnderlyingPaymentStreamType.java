...
public class UnderlyingPaymentStreamType extends IntField {
  static final long serialVersionUID = 552892318L;

  public static final int FIELD = 40568;
  ...
  public UnderlyingPaymentStreamType(Integer data) {
    super(40568, data);
  }

  public UnderlyingPaymentStreamType(int data) {
    super(40568, data);
  }
}
