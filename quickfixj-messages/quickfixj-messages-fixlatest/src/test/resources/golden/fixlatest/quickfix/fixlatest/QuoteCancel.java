...
public static class NoTargetPartySubIDs extends Group {
  ...
  public void set(quickfix.fixlatest.component.QuotCxlEntriesGrp component) {
    setComponent(component);
  }

  public quickfix.fixlatest.component.QuotCxlEntriesGrp get(quickfix.fixlatest.component.QuotCxlEntriesGrp component) throws FieldNotFound {
    getComponent(component);
    return component;
  }

  public quickfix.fixlatest.component.QuotCxlEntriesGrp getQuotCxlEntriesGrpComponent() throws FieldNotFound {
    return get(new quickfix.fixlatest.component.QuotCxlEntriesGrp());
  }
