...
public class BusinessDayConvention extends IntField {
  static final long serialVersionUID = 552892318L;

  public static final int FIELD = 40921;
  ...
  public BusinessDayConvention(Integer data) {
    super(40921, data);
  }

  public BusinessDayConvention(int data) {
    super(40921, data);
  }
}
