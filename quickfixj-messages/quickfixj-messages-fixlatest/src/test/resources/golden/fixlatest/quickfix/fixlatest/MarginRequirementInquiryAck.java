...
public class MarginRequirementInquiryAck extends Message {
  static final long serialVersionUID = 552892318L;

  public static final String MSGTYPE = "CI";

  public MarginRequirementInquiryAck() {
    super();
    getHeader().setField(new quickfix.field.MsgType(MSGTYPE));
  }

  public MarginRequirementInquiryAck (quickfix.field.MarginReqmtInqID marginReqmtInqID, quickfix.field.MarginReqmtInqStatus marginReqmtInqStatus) {
    this();
    setField(marginReqmtInqID);
    setField(marginReqmtInqStatus);
  }
...
public static class NoMarginReqmtInqQualifier extends Group {
  ...
  public void set(quickfix.field.MarginReqmtInqStatus value) {
    setField(value);
  }

  public quickfix.field.MarginReqmtInqStatus get(quickfix.field.MarginReqmtInqStatus value) throws FieldNotFound {
    getField(value);
    return value;
  }

  public quickfix.field.MarginReqmtInqStatus getMarginReqmtInqStatus() throws FieldNotFound {
    return get(new quickfix.field.MarginReqmtInqStatus());
  }

  public boolean isSet(quickfix.field.MarginReqmtInqStatus field) {
    return isSetField(field);
  }

  public boolean isSetMarginReqmtInqStatus() {
    return isSetField(1640);
  }

  public void set(quickfix.field.MarginReqmtInqResult value) {
    setField(value);
  }

  public quickfix.field.MarginReqmtInqResult get(quickfix.field.MarginReqmtInqResult value) throws FieldNotFound {
    getField(value);
    return value;
  }

  public quickfix.field.MarginReqmtInqResult getMarginReqmtInqResult() throws FieldNotFound {
    return get(new quickfix.field.MarginReqmtInqResult());
  }

  public boolean isSet(quickfix.field.MarginReqmtInqResult field) {
    return isSetField(field);
  }

  public boolean isSetMarginReqmtInqResult() {
    return isSetField(1641);
  }
