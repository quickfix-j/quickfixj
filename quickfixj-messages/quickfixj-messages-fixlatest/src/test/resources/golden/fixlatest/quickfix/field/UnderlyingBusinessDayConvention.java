...
public class UnderlyingBusinessDayConvention extends IntField {
  static final long serialVersionUID = 552892318L;

  public static final int FIELD = 40964;
  ...
  public UnderlyingBusinessDayConvention(Integer data) {
    super(40964, data);
  }

  public UnderlyingBusinessDayConvention(int data) {
    super(40964, data);
  }
}
