...
public class MassOrderAck extends Message {
  static final long serialVersionUID = 552892318L;

  public static final String MSGTYPE = "DK";
  ...
  public MassOrderAck (quickfix.field.MassOrderRequestStatus massOrderRequestStatus, quickfix.field.TradingCapacity tradingCapacity) {
    this();
    setField(massOrderRequestStatus);
    setField(tradingCapacity);
  }
  ...
  public void set(quickfix.field.MassOrderReportID value) {
    setField(value);
  }

  public quickfix.field.MassOrderReportID get(quickfix.field.MassOrderReportID value) throws FieldNotFound {
    getField(value);
    return value;
  }

  public quickfix.field.MassOrderReportID getMassOrderReportID() throws FieldNotFound {
    return get(new quickfix.field.MassOrderReportID());
  }

  public boolean isSet(quickfix.field.MassOrderReportID field) {
    return isSetField(field);
  }

  public boolean isSetMassOrderReportID() {
    return isSetField(2424);
  }

  public void set(quickfix.field.MassOrderRequestStatus value) {
    setField(value);
  }

  public quickfix.field.MassOrderRequestStatus get(quickfix.field.MassOrderRequestStatus value) throws FieldNotFound {
    getField(value);
    return value;
  }

  public quickfix.field.MassOrderRequestStatus getMassOrderRequestStatus() throws FieldNotFound {
    return get(new quickfix.field.MassOrderRequestStatus());
  }

  public boolean isSet(quickfix.field.MassOrderRequestStatus field) {
    return isSetField(field);
  }

  public boolean isSetMassOrderRequestStatus() {
    return isSetField(2425);
  }

  public void set(quickfix.field.MassOrderRequestResult value) {
    setField(value);
  }

  public quickfix.field.MassOrderRequestResult get(quickfix.field.MassOrderRequestResult value) throws FieldNotFound {
    getField(value);
    return value;
  }

  public quickfix.field.MassOrderRequestResult getMassOrderRequestResult() throws FieldNotFound {
    return get(new quickfix.field.MassOrderRequestResult());
  }

  public boolean isSet(quickfix.field.MassOrderRequestResult field) {
    return isSetField(field);
  }

  public boolean isSetMassOrderRequestResult() {
    return isSetField(2426);
  }
...
public static class NoPartySubIDs extends Group {
  ...
  public void set(quickfix.fixlatest.component.OrderEntryAckGrp component) {
    setComponent(component);
  }

  public quickfix.fixlatest.component.OrderEntryAckGrp get(quickfix.fixlatest.component.OrderEntryAckGrp component) throws FieldNotFound {
    getComponent(component);
    return component;
  }

  public quickfix.fixlatest.component.OrderEntryAckGrp getOrderEntryAckGrpComponent() throws FieldNotFound {
    return get(new quickfix.fixlatest.component.OrderEntryAckGrp());
  }
