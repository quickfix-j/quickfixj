...
public class PartyDetailsDefinitionRequest extends Message {
  static final long serialVersionUID = 552892318L;

  public static final String MSGTYPE = "CX";

  public PartyDetailsDefinitionRequest() {
    super();
    getHeader().setField(new quickfix.field.MsgType(MSGTYPE));
  }

  public PartyDetailsDefinitionRequest (quickfix.field.PartyDetailsListRequestID partyDetailsListRequestID) {
    this();
