...
public class SettlMethodElectionDateBusinessDayConvention extends IntField {
  static final long serialVersionUID = 552892318L;

  public static final int FIELD = 42778;
  ...
  public SettlMethodElectionDateBusinessDayConvention(Integer data) {
    super(42778, data);
  }

  public SettlMethodElectionDateBusinessDayConvention(int data) {
    super(42778, data);
  }
}
