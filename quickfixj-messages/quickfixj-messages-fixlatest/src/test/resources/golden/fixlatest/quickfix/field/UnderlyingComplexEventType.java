...
public class UnderlyingComplexEventType extends IntField {
  static final long serialVersionUID = 552892318L;

  public static final int FIELD = 2046;
  ...
  public UnderlyingComplexEventType(Integer data) {
    super(2046, data);
  }

  public UnderlyingComplexEventType(int data) {
    super(2046, data);
  }
}
