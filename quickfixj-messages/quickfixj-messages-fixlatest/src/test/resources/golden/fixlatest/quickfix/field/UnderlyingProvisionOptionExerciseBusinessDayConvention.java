...
public class UnderlyingProvisionOptionExerciseBusinessDayConvention extends IntField {
  static final long serialVersionUID = 552892318L;

  public static final int FIELD = 42115;
  ...
  public UnderlyingProvisionOptionExerciseBusinessDayConvention(Integer data) {
    super(42115, data);
  }

  public UnderlyingProvisionOptionExerciseBusinessDayConvention(int data) {
    super(42115, data);
  }
}
