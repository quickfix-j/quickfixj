...
public class RequestedPartyRole extends IntField {
  static final long serialVersionUID = 552892318L;

  public static final int FIELD = 1509;
  ...
  public RequestedPartyRole(Integer data) {
    super(1509, data);
  }

  public RequestedPartyRole(int data) {
    super(1509, data);
  }
}
