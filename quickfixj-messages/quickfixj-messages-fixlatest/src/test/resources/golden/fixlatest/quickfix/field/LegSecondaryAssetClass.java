...
public class LegSecondaryAssetClass extends IntField {
  static final long serialVersionUID = 552892318L;

  public static final int FIELD = 2077;
  ...
  public LegSecondaryAssetClass(Integer data) {
    super(2077, data);
  }

  public LegSecondaryAssetClass(int data) {
    super(2077, data);
  }
}
