...
public class InstrumentScopeSecurityType extends StringField {
  static final long serialVersionUID = 552892318L;

  public static final int FIELD = 1547;

  public static final String USTREASURY_NOTE_OLD = "UST";

  public static final String USTREASURY_BILL_OLD = "USTB";
  ...
  public static final String USCORPORATE_FLOATING_RATE_NOTES = "FRN";
  ...
  public static final String NON_DELIVERABLE_SWAP = "FXNDS";
  ...
  public static final String COMMODITY_SWAP = "CMDTYSWAP";
  ...
  public static final String DERIVATIVE_FORWARD = "FWD";

  public static final String INTEREST_RATE_SWAP = "IRS";

  public static final String TOTAL_RETURN_SWAP = "TRS";

  public static final String LOAN_LEASE = "LOANLEASE";
  ...
  public static final String SPOT_FORWARD = "SPOTFWD";

  public static final String SWAP_OPTION = "SWAPTION";

  public static final String TRANSMISSION = "XMISSION";

  public static final String INDEX = "INDEX";

  public static final String BOND_BASKET = "BDBSKT";

  public static final String CONTRACT_FOR_DIFFERENCE = "CFD";

  public static final String CORRELATION_SWAP = "CRLTNSWAP";

  public static final String DIVIEND_SWAP = "DVDNDSWAP";

  public static final String EQUITY_BASKET = "EQBSKT";

  public static final String EQUITY_FORWARD = "EQFWD";

  public static final String RETURN_SWAP = "RTRNSWAP";

  public static final String VARIANCE_SWAP = "VARSWAP";

  public static final String PORTFOLIO_SWAPS = "PRTFLIOSWAP";

  public static final String FUTURES_ON_ASWAP = "FUTSWAP";

  public static final String FORWARDS_ON_ASWAP = "FWDSWAP";

  public static final String FORWARD_FREIGHT_AGREEMENT = "FWDFRTAGMT";

  public static final String SPREAD_BETTING = "SPREADBET";

  public static final String EXCHANGE_TRADED_COMMODITY = "ETC";

  public static final String COMMON_STOCK = "CS";

  public static final String PREFERRED_STOCK = "PS";

  public static final String DEPOSITORY_RECEIPTS = "DR";
  ...
  public static final String DELIVERY_VERSUS_PLEDGE = "DVPLDG";

  public static final String COLLATERAL_BASKET = "COLLBSKT";

  public static final String STRUCTURED_FINANCE_PRODUCT = "SFP";

  public static final String MARGIN_LOAN = "MRGNLOAN";
  ...
  public static final String PRINCIPAL_STRIP_FROM_ANON_CALLABLE_BOND_OR_NOTE = "TPRN";
  ...
  public static final String EXCHANGE_TRADED_NOTE = "ETN";

  public static final String SECURITIZED_DERIVATIVE = "SECDERIV";

  public InstrumentScopeSecurityType() {
    super(1547);
  }

  public InstrumentScopeSecurityType(String data) {
    super(1547, data);
  }
}
