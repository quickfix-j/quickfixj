...
public class LegPaymentStreamInflationLagDayType extends IntField {
  static final long serialVersionUID = 552892318L;

  public static final int FIELD = 40352;
  ...
  public LegPaymentStreamInflationLagDayType(Integer data) {
    super(40352, data);
  }

  public LegPaymentStreamInflationLagDayType(int data) {
    super(40352, data);
  }
}
