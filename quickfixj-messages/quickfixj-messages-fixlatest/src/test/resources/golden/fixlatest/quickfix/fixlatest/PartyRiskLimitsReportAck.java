...
public class PartyRiskLimitsReportAck extends Message {
  static final long serialVersionUID = 552892318L;

  public static final String MSGTYPE = "DE";

  public PartyRiskLimitsReportAck() {
    super();
    getHeader().setField(new quickfix.field.MsgType(MSGTYPE));
  }

  public PartyRiskLimitsReportAck (quickfix.field.RiskLimitReportID riskLimitReportID, quickfix.field.RiskLimitReportStatus riskLimitReportStatus) {
    this();
    setField(riskLimitReportID);
    setField(riskLimitReportStatus);
  }

  public void set(quickfix.field.RiskLimitReportID value) {
    setField(value);
  }

  public quickfix.field.RiskLimitReportID get(quickfix.field.RiskLimitReportID value) throws FieldNotFound {
    getField(value);
    return value;
  }

  public quickfix.field.RiskLimitReportID getRiskLimitReportID() throws FieldNotFound {
    return get(new quickfix.field.RiskLimitReportID());
  }

  public boolean isSet(quickfix.field.RiskLimitReportID field) {
    return isSetField(field);
  }

  public boolean isSetRiskLimitReportID() {
    return isSetField(1667);
  }
  ...
  public void set(quickfix.field.RiskLimitReportStatus value) {
    setField(value);
  }

  public quickfix.field.RiskLimitReportStatus get(quickfix.field.RiskLimitReportStatus value) throws FieldNotFound {
    getField(value);
    return value;
  }

  public quickfix.field.RiskLimitReportStatus getRiskLimitReportStatus() throws FieldNotFound {
    return get(new quickfix.field.RiskLimitReportStatus());
  }

  public boolean isSet(quickfix.field.RiskLimitReportStatus field) {
    return isSetField(field);
  }

  public boolean isSetRiskLimitReportStatus() {
    return isSetField(2316);
  }

  public void set(quickfix.field.RiskLimitReportRejectReason value) {
    setField(value);
  }

  public quickfix.field.RiskLimitReportRejectReason get(quickfix.field.RiskLimitReportRejectReason value) throws FieldNotFound {
    getField(value);
    return value;
  }

  public quickfix.field.RiskLimitReportRejectReason getRiskLimitReportRejectReason() throws FieldNotFound {
    return get(new quickfix.field.RiskLimitReportRejectReason());
  }

  public boolean isSet(quickfix.field.RiskLimitReportRejectReason field) {
    return isSetField(field);
  }

  public boolean isSetRiskLimitReportRejectReason() {
    return isSetField(2317);
  }

  public void set(quickfix.fixlatest.component.PartyRiskLimitsUpdateGrp component) {
    setComponent(component);
  }

  public quickfix.fixlatest.component.PartyRiskLimitsUpdateGrp get(quickfix.fixlatest.component.PartyRiskLimitsUpdateGrp component) throws FieldNotFound {
    getComponent(component);
    return component;
  }

  public quickfix.fixlatest.component.PartyRiskLimitsUpdateGrp getPartyRiskLimitsUpdateGrpComponent() throws FieldNotFound {
    return get(new quickfix.fixlatest.component.PartyRiskLimitsUpdateGrp());
  }
...
public static class NoPartyRiskLimits extends Group {
  static final long serialVersionUID = 552892318L;
  private static final int[]  ORDER = {1324, 1671, 1669, 1670, 2339, 2355, 0};
