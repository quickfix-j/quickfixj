...
public class RequestedPartyRoleQualifier extends IntField {
  static final long serialVersionUID = 552892318L;

  public static final int FIELD = 2386;
  ...
  public RequestedPartyRoleQualifier(Integer data) {
    super(2386, data);
  }

  public RequestedPartyRoleQualifier(int data) {
    super(2386, data);
  }
}
