...
public class RequestingPartyRoleQualifier extends IntField {
  static final long serialVersionUID = 552892318L;

  public static final int FIELD = 2338;
  ...
  public RequestingPartyRoleQualifier(Integer data) {
    super(2338, data);
  }

  public RequestingPartyRoleQualifier(int data) {
    super(2338, data);
  }
}
