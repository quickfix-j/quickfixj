...
public class UnderlyingProvisionCashSettlPaymentDateBusinessDayConvention extends IntField {
  static final long serialVersionUID = 552892318L;

  public static final int FIELD = 42092;
  ...
  public UnderlyingProvisionCashSettlPaymentDateBusinessDayConvention(Integer data) {
    super(42092, data);
  }

  public UnderlyingProvisionCashSettlPaymentDateBusinessDayConvention(int data) {
    super(42092, data);
  }
}
