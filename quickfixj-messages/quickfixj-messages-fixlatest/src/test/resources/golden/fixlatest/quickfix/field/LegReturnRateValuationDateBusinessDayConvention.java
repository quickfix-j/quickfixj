...
public class LegReturnRateValuationDateBusinessDayConvention extends IntField {
  static final long serialVersionUID = 552892318L;

  public static final int FIELD = 42529;
  ...
  public LegReturnRateValuationDateBusinessDayConvention(Integer data) {
    super(42529, data);
  }

  public LegReturnRateValuationDateBusinessDayConvention(int data) {
    super(42529, data);
  }
}
