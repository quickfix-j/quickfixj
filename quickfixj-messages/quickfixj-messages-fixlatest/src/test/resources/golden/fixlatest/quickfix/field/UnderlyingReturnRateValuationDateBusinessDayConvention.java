...
public class UnderlyingReturnRateValuationDateBusinessDayConvention extends IntField {
  static final long serialVersionUID = 552892318L;

  public static final int FIELD = 43029;
  ...
  public UnderlyingReturnRateValuationDateBusinessDayConvention(Integer data) {
    super(43029, data);
  }

  public UnderlyingReturnRateValuationDateBusinessDayConvention(int data) {
    super(43029, data);
  }
}
