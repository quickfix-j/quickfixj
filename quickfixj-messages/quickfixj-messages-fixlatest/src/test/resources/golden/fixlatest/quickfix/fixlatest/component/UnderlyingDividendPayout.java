...
public class UnderlyingDividendPayout extends quickfix.MessageComponent {
  static final long serialVersionUID = 552892318L;

  public static final String MSGTYPE = "";
  private int[] componentFields = {42860, 42861, };
  protected int[] getFields() { return componentFields; }
  private int[] componentGroups = {};
  protected int[] getGroupFields() { return componentGroups; }

  public UnderlyingDividendPayout() {
    super();
  }

  public void set(quickfix.field.UnderlyingDividendPayoutRatio value) {
    setField(value);
  }

  public quickfix.field.UnderlyingDividendPayoutRatio get(quickfix.field.UnderlyingDividendPayoutRatio value) throws FieldNotFound {
    getField(value);
    return value;
  }

  public quickfix.field.UnderlyingDividendPayoutRatio getUnderlyingDividendPayoutRatio() throws FieldNotFound {
    return get(new quickfix.field.UnderlyingDividendPayoutRatio());
  }

  public boolean isSet(quickfix.field.UnderlyingDividendPayoutRatio field) {
    return isSetField(field);
  }

  public boolean isSetUnderlyingDividendPayoutRatio() {
    return isSetField(42860);
  }

  public void set(quickfix.field.UnderlyingDividendPayoutConditions value) {
    setField(value);
  }

  public quickfix.field.UnderlyingDividendPayoutConditions get(quickfix.field.UnderlyingDividendPayoutConditions value) throws FieldNotFound {
    getField(value);
    return value;
  }

  public quickfix.field.UnderlyingDividendPayoutConditions getUnderlyingDividendPayoutConditions() throws FieldNotFound {
    return get(new quickfix.field.UnderlyingDividendPayoutConditions());
  }

  public boolean isSet(quickfix.field.UnderlyingDividendPayoutConditions field) {
    return isSetField(field);
  }

  public boolean isSetUnderlyingDividendPayoutConditions() {
    return isSetField(42861);
  }

  public void set(quickfix.fixlatest.component.UnderlyingDividendPaymentGrp component) {
    setComponent(component);
  }

  public quickfix.fixlatest.component.UnderlyingDividendPaymentGrp get(quickfix.fixlatest.component.UnderlyingDividendPaymentGrp component) throws FieldNotFound {
    getComponent(component);
    return component;
  }

  public quickfix.fixlatest.component.UnderlyingDividendPaymentGrp getUnderlyingDividendPaymentGrpComponent() throws FieldNotFound {
    return get(new quickfix.fixlatest.component.UnderlyingDividendPaymentGrp());
  }
