...
public class InstrumentPartyRoleQualifier extends IntField {
  static final long serialVersionUID = 552892318L;

  public static final int FIELD = 2378;
  ...
  public InstrumentPartyRoleQualifier(Integer data) {
    super(2378, data);
  }

  public InstrumentPartyRoleQualifier(int data) {
    super(2378, data);
  }
}
