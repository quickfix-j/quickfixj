...
public class TradingSessionStatus extends Message {
  ...
  public void set(quickfix.field.TradSesControl value) {
    setField(value);
  }

  public quickfix.field.TradSesControl get(quickfix.field.TradSesControl value) throws FieldNotFound {
    getField(value);
    return value;
  }

  public quickfix.field.TradSesControl getTradSesControl() throws FieldNotFound {
    return get(new quickfix.field.TradSesControl());
  }

  public boolean isSet(quickfix.field.TradSesControl field) {
    return isSetField(field);
  }

  public boolean isSetTradSesControl() {
    return isSetField(1785);
  }
