...
public class ProvisionDateBusinessDayConvention extends IntField {
  static final long serialVersionUID = 552892318L;

  public static final int FIELD = 40093;
  ...
  public ProvisionDateBusinessDayConvention(Integer data) {
    super(40093, data);
  }

  public ProvisionDateBusinessDayConvention(int data) {
    super(40093, data);
  }
}
