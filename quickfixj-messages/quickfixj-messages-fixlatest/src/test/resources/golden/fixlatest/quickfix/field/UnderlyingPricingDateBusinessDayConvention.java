...
public class UnderlyingPricingDateBusinessDayConvention extends IntField {
  static final long serialVersionUID = 552892318L;

  public static final int FIELD = 41950;
  ...
  public UnderlyingPricingDateBusinessDayConvention(Integer data) {
    super(41950, data);
  }

  public UnderlyingPricingDateBusinessDayConvention(int data) {
    super(41950, data);
  }
}
