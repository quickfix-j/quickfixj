...
public static class NoPartySubIDs extends Group {
  ...
  public void set(quickfix.fixlatest.component.RgstDtlsGrp component) {
    setComponent(component);
  }

  public quickfix.fixlatest.component.RgstDtlsGrp get(quickfix.fixlatest.component.RgstDtlsGrp component) throws FieldNotFound {
    getComponent(component);
    return component;
  }

  public quickfix.fixlatest.component.RgstDtlsGrp getRgstDtlsGrpComponent() throws FieldNotFound {
    return get(new quickfix.fixlatest.component.RgstDtlsGrp());
  }
...
public static class NoNestedPartySubIDs extends Group {
  ...
  public void set(quickfix.fixlatest.component.RgstDistInstGrp component) {
    setComponent(component);
  }

  public quickfix.fixlatest.component.RgstDistInstGrp get(quickfix.fixlatest.component.RgstDistInstGrp component) throws FieldNotFound {
    getComponent(component);
    return component;
  }

  public quickfix.fixlatest.component.RgstDistInstGrp getRgstDistInstGrpComponent() throws FieldNotFound {
    return get(new quickfix.fixlatest.component.RgstDistInstGrp());
  }
