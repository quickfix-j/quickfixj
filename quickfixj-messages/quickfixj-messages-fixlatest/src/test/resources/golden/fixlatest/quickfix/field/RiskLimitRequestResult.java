...
public class RiskLimitRequestResult extends IntField {
  static final long serialVersionUID = 552892318L;

  public static final int FIELD = 1761;
  ...
  public RiskLimitRequestResult(Integer data) {
    super(1761, data);
  }

  public RiskLimitRequestResult(int data) {
    super(1761, data);
  }
}
