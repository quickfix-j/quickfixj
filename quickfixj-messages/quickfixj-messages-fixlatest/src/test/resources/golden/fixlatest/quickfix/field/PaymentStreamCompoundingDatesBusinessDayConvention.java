...
public class PaymentStreamCompoundingDatesBusinessDayConvention extends IntField {
  static final long serialVersionUID = 552892318L;

  public static final int FIELD = 42609;
  ...
  public PaymentStreamCompoundingDatesBusinessDayConvention(Integer data) {
    super(42609, data);
  }

  public PaymentStreamCompoundingDatesBusinessDayConvention(int data) {
    super(42609, data);
  }
}
