...
public class ComplexEventCreditEventDayType extends IntField {
  static final long serialVersionUID = 552892318L;

  public static final int FIELD = 41003;
  ...
  public ComplexEventCreditEventDayType(Integer data) {
    super(41003, data);
  }

  public ComplexEventCreditEventDayType(int data) {
    super(41003, data);
  }
}
