...
public class PaymentStubEndDateOffsetDayType extends IntField {
  static final long serialVersionUID = 552892318L;

  public static final int FIELD = 42694;
  ...
  public PaymentStubEndDateOffsetDayType(Integer data) {
    super(42694, data);
  }

  public PaymentStubEndDateOffsetDayType(int data) {
    super(42694, data);
  }
}
