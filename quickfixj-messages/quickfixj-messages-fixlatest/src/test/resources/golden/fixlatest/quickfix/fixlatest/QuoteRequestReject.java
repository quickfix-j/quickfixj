...
public static class NoRootPartySubIDs extends Group {
  ...
  public void set(quickfix.fixlatest.component.QuotReqRjctGrp component) {
    setComponent(component);
  }

  public quickfix.fixlatest.component.QuotReqRjctGrp get(quickfix.fixlatest.component.QuotReqRjctGrp component) throws FieldNotFound {
    getComponent(component);
    return component;
  }

  public quickfix.fixlatest.component.QuotReqRjctGrp getQuotReqRjctGrpComponent() throws FieldNotFound {
    return get(new quickfix.fixlatest.component.QuotReqRjctGrp());
  }
