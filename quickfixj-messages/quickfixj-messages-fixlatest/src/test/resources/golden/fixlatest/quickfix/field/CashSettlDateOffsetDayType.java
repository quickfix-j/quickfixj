...
public class CashSettlDateOffsetDayType extends IntField {
  static final long serialVersionUID = 552892318L;

  public static final int FIELD = 42212;
  ...
  public CashSettlDateOffsetDayType(Integer data) {
    super(42212, data);
  }

  public CashSettlDateOffsetDayType(int data) {
    super(42212, data);
  }
}
