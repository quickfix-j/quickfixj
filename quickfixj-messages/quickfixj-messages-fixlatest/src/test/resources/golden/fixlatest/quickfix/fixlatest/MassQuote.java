...
public static class NoPartySubIDs extends Group {
  ...
  public void set(quickfix.fixlatest.component.QuotSetGrp component) {
    setComponent(component);
  }

  public quickfix.fixlatest.component.QuotSetGrp get(quickfix.fixlatest.component.QuotSetGrp component) throws FieldNotFound {
    getComponent(component);
    return component;
  }

  public quickfix.fixlatest.component.QuotSetGrp getQuotSetGrpComponent() throws FieldNotFound {
    return get(new quickfix.fixlatest.component.QuotSetGrp());
  }
