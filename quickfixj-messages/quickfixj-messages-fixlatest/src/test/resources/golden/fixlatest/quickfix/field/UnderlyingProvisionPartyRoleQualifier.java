...
public class UnderlyingProvisionPartyRoleQualifier extends IntField {
  static final long serialVersionUID = 552892318L;

  public static final int FIELD = 40918;
  ...
  public UnderlyingProvisionPartyRoleQualifier(Integer data) {
    super(40918, data);
  }

  public UnderlyingProvisionPartyRoleQualifier(int data) {
    super(40918, data);
  }
}
