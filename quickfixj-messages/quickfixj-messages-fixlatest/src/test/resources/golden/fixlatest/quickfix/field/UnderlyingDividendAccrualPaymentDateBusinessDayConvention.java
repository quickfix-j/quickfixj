...
public class UnderlyingDividendAccrualPaymentDateBusinessDayConvention extends IntField {
  static final long serialVersionUID = 552892318L;

  public static final int FIELD = 42824;
  ...
  public UnderlyingDividendAccrualPaymentDateBusinessDayConvention(Integer data) {
    super(42824, data);
  }

  public UnderlyingDividendAccrualPaymentDateBusinessDayConvention(int data) {
    super(42824, data);
  }
}
