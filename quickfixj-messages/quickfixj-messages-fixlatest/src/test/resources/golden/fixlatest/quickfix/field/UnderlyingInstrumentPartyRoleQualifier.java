...
public class UnderlyingInstrumentPartyRoleQualifier extends IntField {
  static final long serialVersionUID = 552892318L;

  public static final int FIELD = 2391;
  ...
  public UnderlyingInstrumentPartyRoleQualifier(Integer data) {
    super(2391, data);
  }

  public UnderlyingInstrumentPartyRoleQualifier(int data) {
    super(2391, data);
  }
}
