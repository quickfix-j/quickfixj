...
public class RelatedPartyDetailRole extends IntField {
  static final long serialVersionUID = 552892318L;

  public static final int FIELD = 1565;
  ...
  public RelatedPartyDetailRole(Integer data) {
    super(1565, data);
  }

  public RelatedPartyDetailRole(int data) {
    super(1565, data);
  }
}
