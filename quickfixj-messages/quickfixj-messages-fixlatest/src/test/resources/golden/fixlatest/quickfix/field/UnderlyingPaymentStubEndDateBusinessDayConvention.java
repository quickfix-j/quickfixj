...
public class UnderlyingPaymentStubEndDateBusinessDayConvention extends IntField {
  static final long serialVersionUID = 552892318L;

  public static final int FIELD = 42985;
  ...
  public UnderlyingPaymentStubEndDateBusinessDayConvention(Integer data) {
    super(42985, data);
  }

  public UnderlyingPaymentStubEndDateBusinessDayConvention(int data) {
    super(42985, data);
  }
}
