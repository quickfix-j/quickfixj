...
public class PaymentSettlPartyRole extends IntField {
  static final long serialVersionUID = 552892318L;

  public static final int FIELD = 40236;
  ...
  public PaymentSettlPartyRole(Integer data) {
    super(40236, data);
  }

  public PaymentSettlPartyRole(int data) {
    super(40236, data);
  }
}
