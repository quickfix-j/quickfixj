...
public class LegPaymentScheduleInterimExchangeDatesBusinessDayConvention extends IntField {
  static final long serialVersionUID = 552892318L;

  public static final int FIELD = 40408;
  ...
  public LegPaymentScheduleInterimExchangeDatesBusinessDayConvention(Integer data) {
    super(40408, data);
  }

  public LegPaymentScheduleInterimExchangeDatesBusinessDayConvention(int data) {
    super(40408, data);
  }
}
