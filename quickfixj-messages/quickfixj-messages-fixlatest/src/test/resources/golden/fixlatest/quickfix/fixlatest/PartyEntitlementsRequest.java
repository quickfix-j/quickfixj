...
public class PartyEntitlementsRequest extends Message {
  static final long serialVersionUID = 552892318L;

  public static final String MSGTYPE = "CU";
...
public static class NoRequestedPartyRoles extends Group {
  ...
  public void set(quickfix.fixlatest.component.EntitlementTypeGrp component) {
    setComponent(component);
  }

  public quickfix.fixlatest.component.EntitlementTypeGrp get(quickfix.fixlatest.component.EntitlementTypeGrp component) throws FieldNotFound {
    getComponent(component);
    return component;
  }

  public quickfix.fixlatest.component.EntitlementTypeGrp getEntitlementTypeGrpComponent() throws FieldNotFound {
    return get(new quickfix.fixlatest.component.EntitlementTypeGrp());
  }
