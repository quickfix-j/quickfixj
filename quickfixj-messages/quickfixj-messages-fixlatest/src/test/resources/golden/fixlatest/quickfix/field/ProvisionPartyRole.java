...
public class ProvisionPartyRole extends IntField {
  static final long serialVersionUID = 552892318L;

  public static final int FIELD = 40177;
  ...
  public ProvisionPartyRole(Integer data) {
    super(40177, data);
  }

  public ProvisionPartyRole(int data) {
    super(40177, data);
  }
}
