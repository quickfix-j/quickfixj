...
public abstract class FieldMap implements Serializable {
	...
	protected FieldMap(int[] fieldOrder) {
		...
		fields = new TreeMap(fieldOrder != null ? new FieldOrderComparator()
				: null);
	}
	...
	private class FieldOrderComparator implements Comparator, Serializable {
		...
		public int compare(Object o1, Object o2) {
			...
			if ((index1 != Integer.MAX_VALUE) && (index2 != Integer.MAX_VALUE)) {
			...
			} else if ((index1 == Integer.MAX_VALUE)
				...
				if (index1 != index2) {
					...
					// tags
					return tag1.intValue() != tag2.intValue() ? (tag1
							.intValue() < tag2.intValue() ? -1 : 1) : 0;
				}
			} else {
				return tag1.intValue() != tag2.intValue() ? (tag1.intValue() < tag2
						.intValue() ? -1 : 1)
						: 0;
			}
		}
