...
public class FIXMessageDecoderOrig implements MessageDecoder {
    ...
    public MessageDecoderResult decode(ProtocolSession session, ByteBuffer in,
        ...
        System.out.println("@@@@@ BUFFER "+in.remaining()+" "+in.position());
        while (true) {
            try {
                ...
                if (state == READING_BODY) {
                    System.out.println("@@@@@ bodyLength "+bodyLength+" "+(in.limit() - position));
                ...
                if (state == PARSING_CHECKSUM) {
                    ...
                    System.out.println("@@@@@ MESSAGE "+in.position()+" "+messageString);
