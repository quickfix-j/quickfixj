...
public class SessionScheduleTest extends TestCase {
    ...
    public void testIsSameSessionForDailyWithFullDaySchedule() throws Exception {
        SessionSchedule schedule = newSessionSchedule(getUtcTime(0, 0, 0).getTime(), getUtcTime(0,
                0, 0).getTime(), -1, -1);

        Calendar t1 = getUtcTimeStamp(2004, 6, 25, 3, 0, 0);
        Calendar t2 = getUtcTimeStamp(2004, 6, 25, 5, 0, 0);
        doIsSameSessionTest(schedule, t1, t2, true);

        t1 = getUtcTimeStamp(2004, 6, 25, 3, 0, 0);
        t2 = getUtcTimeStamp(2004, 6, 26, 5, 0, 0);
        doIsSameSessionTest(schedule, t1, t2, false);

    }

    public void testIsSameSessionForDailyWithFullWeekSchedule() throws Exception {
        SessionSchedule schedule = newSessionSchedule(getUtcTime(0, 0, 0).getTime(), getUtcTime(0,
                0, 0).getTime(), 1, 1);
        ...
        t1 = getUtcTimeStamp(2004, 6, 25, 3, 0, 0);
        t2 = getUtcTimeStamp(2004, 7, 8, 5, 0, 0);
        doIsSameSessionTest(schedule, t1, t2, false);
