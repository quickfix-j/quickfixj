...
//    private static final int NUMBER_OF_ADMIN_MESSAGES = 50;
    ...
    @Test
    public void test() {
        // The test testSessionResetDeadlock needs to be re-enabled once we have JDK1.6 support
        // since it uses  ManagementFactory.getThreadMXBean().findDeadlockedThreads()
    }
