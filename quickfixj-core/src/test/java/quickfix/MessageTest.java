...
public class MessageTest {
  ...
  private NewOrderSingle createNewOrderSingle() {
    return new NewOrderSingle(
        ...
        new Symbol("ORCL"), new Side(Side.BUY),
  ...
  public void testHeaderCustomFieldOrdering() throws Exception {
    ...
    class MyMessage extends Message {
      ...
      final int[] headerFieldOrder = {BeginString.FIELD,  BodyLength.FIELD,
                                      MsgType.FIELD,      TargetSubID.FIELD,
                                      SendingTime.FIELD,  MsgSeqNum.FIELD,
                                      SenderCompID.FIELD, TargetCompID.FIELD};
  ...
  @Test
  public void
  testHeaderFieldWithCustomTransportDictionaryConstructorReadsHeaderField()
      throws Exception {

    final DataDictionary customSessionDictionary =
        new DataDictionary("FIXT11_Custom_Test.xml");
    customSessionDictionary.setAllowUnknownMessageFields(false);

    final DataDictionary standardSessionDictionary =
        new DataDictionary("FIXT11.xml");
    standardSessionDictionary.setAllowUnknownMessageFields(false);

    final DataDictionary applicationDictionary =
        new DataDictionary("FIX50.xml");
    ...
    final Message standardMessage = new Message(
        messageData, standardSessionDictionary, applicationDictionary, true);
    ...
    // Test that field is correctly classified in header with
    // customSessionDictionary
    final Message customMessage = new Message(
        messageData, customSessionDictionary, applicationDictionary, true);
  ...
  public void testHeaderGroupParsing() throws Exception {
    ...
    final quickfix.fix44.Message.Header.NoHops hops =
        new quickfix.fix44.Message.Header.NoHops();
  ...
  public void testEmbeddedMessage() throws Exception {
    ...
    final ExecutionReport report = new ExecutionReport(
        new OrderID("ORDER"), new ExecID("EXEC"), new ExecType(ExecType.FILL),
        new OrdStatus(OrdStatus.FILLED), new Side(Side.BUY), new LeavesQty(100),
        new CumQty(100), new AvgPx(50));
    ...
    final Message msg =
        new Message(report.toString(), DataDictionaryTest.getDictionary());
  ...
  private void doTestMessageWithEncodedField(String charset, String text)
    ...
    try {
      ...
      order.set(new EncodedTextLen(
          MessageUtils.length(CharsetSupport.getCharsetInstance(), text)));
      order.set(new EncodedText(text));
      final Message msg =
          new Message(order.toString(), DataDictionaryTest.getDictionary());
      assertEquals(charset + " encoded field", text,
                   msg.getString(EncodedText.FIELD));
    } finally {
  ...
  public void testMessageWithEncodedField() throws Exception {
    String text =
        "\u6D4B\u9A8C\001\u6570\u636E"; // Chinese with SOH in the middle
    ...
    //        doTestMessageWithEncodedField("UTF-16", text); // double-byte
    //        charset not supported yet
  }
  ...
  public void testParsing() throws Exception {
    ...
    assertEquals("wrong value", "D",
                 valueMessageType.getString(RefMsgType.FIELD));
    assertEquals("wrong value", "R",
                 valueMessageType.getString(MsgDirection.FIELD));
    message.getGroup(2, valueMessageType);
    assertEquals("wrong value", "8",
                 valueMessageType.getString(RefMsgType.FIELD));
    assertEquals("wrong value", "S",
                 valueMessageType.getString(MsgDirection.FIELD));
  }
  ...
  public void testParsing2() throws Exception {
    ...
    final IndicationOfInterest.NoUnderlyings valueMessageType =
        new IndicationOfInterest.NoUnderlyings();
    message.getGroup(1, valueMessageType);
    assertEquals("wrong value", "DELL",
                 valueMessageType.getString(UnderlyingSymbol.FIELD));
    assertEquals("wrong value", "USD",
                 valueMessageType.getString(UnderlyingCurrency.FIELD));
    message.getGroup(2, valueMessageType);
    assertEquals("wrong value", "IBM",
                 valueMessageType.getString(UnderlyingSymbol.FIELD));
    assertEquals("wrong value", "CAD",
                 valueMessageType.getString(UnderlyingCurrency.FIELD));
  }
  ...
  public void testValidation() throws Exception {
    final String data =
        "8=FIX.4.4\0019=309\00135=8\00149=ASX\00156=CL1_FIX44\00134=4\001"
        +
  ...
  public void testAppMessageValidation() throws Exception {
    final String data =
        "8=FIXT.1.1\0019=234\00135=W\00134=2\00149=ABFX\00152=20080722-16:37:11.234\001"
        +
    ...
    final MarketDataSnapshotFullRefresh mdsfr =
  ...
  public void testGroupDelimOrdering() throws Exception {
    ...
    final quickfix.fix44.NewOrderSingle order =
        new quickfix.fix44.NewOrderSingle();
    final Group partyGroup =
        new Group(quickfix.field.NoPartyIDs.FIELD, PartyID.FIELD);
   ...
   * the QuickFIX mailing list. The problem was the user's configuration but
   * this seems like a good unit test to keep in the suite.
   */
  @Test
  public void testDataFieldParsing() throws Exception {
    final String data =
        "10001=Canonical.1.00\00110002=001058\00125001=01\00110003=SAPI_ADMRESP\00110004=SUBSCRIBE_RESP\001"
        +
  ...
  public void testCalculateStringWithNestedGroups() throws Exception {
    ...
    final NewOrderCross.NoSides.NoPartyIDs party =
        new NewOrderCross.NoSides.NoPartyIDs();
    ...
    final String expectedMessage =
        "8=FIX.4.4\0019=247\00135=s\00134=5\00149=sender\00152=20060319-09:08:20.881\001"
        +
  ...
  public void testFieldOrdering() throws Exception {
    final String expectedMessageString =
        "8=FIX.4.4\0019=171\00135=D\00149=SenderCompId\00156=TargetCompId\001"
        +
    ...
    final Message message =
        new DefaultMessageFactory().create(dataDictionary.getVersion(), "D");
    ...
    assertTrue(
        ...
        actualMessageString.contains(
            "453=2\001448=8\001447=D\001452=4\001448=AAA35354\001447=D\001452=3"));
  }
  ...
  public void testHeaderFieldInBody() throws Exception {
    ...
    assertEquals(SessionRejectReason.TAG_SPECIFIED_OUT_OF_REQUIRED_ORDER,
                 message.getException().getSessionRejectReason());
  ...
  public void testMessageFromString() {
    ...
    try {
      message =
          new Message("8=FIX.4.2\0019=12\00135=A\001108=30\00110=026\001");
    } catch (final InvalidMessage e) {
  ...
  public void testMessageGroupCountValidation() throws Exception {
    final String data =
        "8=FIX.4.4\0019=222\00135=D\00149=SenderCompId\00156=TargetCompId\00134=37\001"
        +
  ...
  public void testMessageWithMissingChecksumField() throws Exception {
    // checksum is "merged" into field 452, i.e. SOH is missing between field
    // 452 and 10
    String badMessage =
        "8=FIX.4.4\0019=275\00135=D\00134=3\00149=441000-XXXXX-X-XXXX-001\001"
        +
  ...
  public void testFieldOrderAfterClone() {
    ...
    final quickfix.fix44.NewOrderSingle.NoPartyIDs partyIdGroup =
        new quickfix.fix44.NewOrderSingle.NoPartyIDs();
    partyIdGroup.set(new PartyID("PARTY_1"));
    partyIdGroup.set(new PartyIDSource(
        PartyIDSource
  ...
  public void testMessageGroupRemovalUsingGroupObject() {
    ...
    assertEquals("wrong # of group members", 2,
                 message.getGroupCount(numAllocs.getFieldTag()));
  ...
  @Test
  public void testMessageSetGetCharsInvalidFormatException()
  ...
  public void testMessageSetGetUtcTimeStamp() {
    ...
    final LocalDateTime time = LocalDateTime.ofInstant(
        Instant.ofEpochMilli(calendar.getTimeInMillis()), ZoneOffset.UTC);
  ...
  public void testComponent() throws Exception {
    ...
    final quickfix.fix44.NewOrderSingle newOrderSingle =
        new quickfix.fix44.NewOrderSingle();
    ...
    assertEquals(new SecurityType(SecurityType.COMMON_STOCK),
  ...
  public void testFalseMessageStructureException() {
    try {
      ...
      new Message(
          ...
          dd, true);
      // For now, this will not cause an exception if the length and checksum
      // are correct
  ...
  public void testComponentInGroup() {
    try {
      ...
      // 602=BRN FMG0010! 63=8 608-FXXXXX 624=1 637=80.09 687=1.0 654=41296073
      // 9019=1 9023=1 9020=20100201 9021=20100228 539=4 524=805\001
      // 525=D\001538=4\001524=11122556 525=D\001538=51 524=Newedge 525=D 538=60
      // 524=U 525=D 538=54 10=112
      new Message(
          "8=FIX.4.4\0019=941\00135=AE\00149=ICE\00134=63\00152=20091117-18:59:04.780\00156=XXXX\001"
              +
              "57=X\001571=219449\001487=0\001856=0\001828=0\001150=F\00117=44750544433\00139=2\001"
  ...
  public void testFalseMessageStructureException2() {
    try {
      ...
      // QFJ-121
      new Message("8=FIX.4.4\0019=22\00135=A\00196=X\001108=30\00110=223\001",
                  dd, true);
    } catch (final Exception e) {
      final String text = e.getMessage();
      assertTrue("Wrong exception message: " + text,
  ...
  public void testEmptyMessageToString() throws Exception {
    ...
    assertTrue("empty message contains no checksum",
  ...
  public void testInvalidHeaderFields() throws Exception {
    String message =
        "1=03100~11=140605JWI4440~15=USD~21=1~35=D~38=6~40=1~47=A~54=1~55=UNP~59=0~60=20140605-13:58:51.016~63=0~79=03100631~336=1~377=N~581=A~6020=COMPUS~86028=JWI~86029=4440~";
  ...
  public void testRepeatingGroupCount() throws Exception {
    ...
    Message tcr = new TradeCaptureReport(
        new TradeReportID("ABC1234"), new PreviouslyReported(false),
        new LastQty(1000), new LastPx(5.6789), new TradeDate("20140101"),
    ...
    tcr.getHeader().setField(
        new SendingTime(LocalDateTime.now(ZoneOffset.UTC)));
     ...
     */
    {
      ...
      Message parsed2 =
          new Message(s2, DataDictionaryTest.getDictionary(), false);
  ...
  @Test
  // QFJ-791
  public void testUnknownFieldsInRepeatingGroupsAndValidation()
      throws Exception {
    ...
    {
      // will add a user-defined tag (i.e. greater than 5000) that is not
      ...
      leg1.setField(
          new StringField(10000, "TXT1")); // add unexpected tag to leg1
      m1.addGroup(leg1);
      m1.addGroup(leg2);
      m1.addGroup(sides);
      ...
      DataDictionary dictionary =
          new DataDictionary(DataDictionaryTest.getDictionary());
...

    {
      ...
      // but without checking for unknown message fields, validation should
      // succeed
  ...
  public void testInvalidFieldInGroup() throws Exception {
    ...
    quickfix.fix44.DerivativeSecurityList responseMessage =
        new quickfix.fix44.DerivativeSecurityList();
    ...
    Group optionGroup =
        new quickfix.fix44.DerivativeSecurityList.NoRelatedSym();
  ...
  @Test
  // QFJ-169/QFJ-791
  public void testNestedRepeatingGroup() throws Exception {

    String newOrdersSingleString =
        "8=FIX.4.4|9=265|35=D|34=62|49=sender|52=20160803-12:55:42.094|"
        +
        ...
        // tag 20000 is not defined, tag 22000 is defined for NewOrderSingle in
        // FIX44_Custom_Test.xml
        +
    ...
    final DataDictionary dataDictionary =
        new DataDictionary("FIX44_Custom_Test.xml");
    dataDictionary.setCheckUserDefinedFields(false);
    nos.fromString(newOrdersSingleString.replaceAll("\\|", "\001"),
                   dataDictionary, true);
    ...
    assertFalse(partyGroup.getGroup(1, quickfix.field.NoPartySubIDs.FIELD)
                    .isSetField(20000));
  }
  ...
  @Test
  // QFJ-169/QFJ-791
  public void testNestedRepeatingSubGroup() throws Exception {
    ...
    assertTrue(partyGroup.getGroup(1, quickfix.field.NoPartySubIDs.FIELD)
                   .isSetField(20000));
  }
  ...
  private void testRepeatingGroupCountForFieldOrder(int fieldOrder[])
      throws Exception {
    /*
  ...
  public void testRepeatingGroupCountWithUnknownFields() throws Exception {
    String test =
        "8=FIX.4.4|9=431|35=d|49=1|34=2|52=20140117-18:20:26.629|56=3|57=21|322=388721|"
        +
  ...
  public void testIfMessageHeaderIsOverwritten() {
    ...
    assertEquals(quickfix.fix42.Message.Header.class,
                 fix42Message.getHeader().getClass());

    final Message fix44Message = new quickfix.fix44.Message();
    assertEquals(quickfix.fix44.Message.Header.class,
                 fix44Message.getHeader().getClass());

    final Message fix50Message = new quickfix.fix50.Message();
    assertEquals(quickfix.fix50.Message.Header.class,
                 fix50Message.getHeader().getClass());

    final Message fixt11Message = new quickfix.fixt11.Message();
    assertEquals(quickfix.fixt11.Message.Header.class,
                 fixt11Message.getHeader().getClass());
  }

  // QFJ-722
  @Test
  public void testIfMessageHeaderIsCreatedWithEveryConstructor()
      throws Exception {
    ...
    final Message sixthConstructor =
        new Message(rawMessage, dataDictionary, false);
    assertNotNull(sixthConstructor.getHeader());

    final Message seventhConstructor =
        new Message(rawMessage, dataDictionary, dataDictionary, false);
    assertNotNull(seventhConstructor.getHeader());
  }

  private void assertHeaderField(Message message, String expectedValue,
  ...
  private void assertTrailerField(Message message, String expectedValue,
                                  int field) throws FieldNotFound {
  ...
  private void assertAllocation(String accountId, Object shares) {
    ...
    case "AllocACC1":
      assertEquals("got shares: " + shares, 0,
                   new BigDecimal("1010.10").compareTo(
                       new BigDecimal(shares.toString())));
      break;
    case "AllocACC2":
      assertEquals("got shares: " + shares, 0,
                   new BigDecimal("2020.20").compareTo(
                       new BigDecimal(shares.toString())));
      break;
    default:
