...
public class FieldConvertersTest extends TestCase {
  ...
  public void testDoubleConversion() throws Exception {
    ...
    assertEquals(45.32, DoubleConverter.convert("45.32"), 0);
    assertEquals(12.000000000001, DoubleConverter.convert("12.000000000001"),
                 0);
  ...
  public void testUtcTimeStampConversion() throws Exception {
    ...
    assertEquals("20000426-12:05:06",
                 UtcTimestampConverter.convert(c.getTime(), false));
    assertEquals("20000426-12:05:06.555",
                 UtcTimestampConverter.convert(c.getTime(), true));
    ...
    LocalDateTime dateTime =
        UtcTimestampConverter.convertToLocalDateTime("20120922-12:34:56");
    ...
    dateTime = UtcTimestampConverter.convertToLocalDateTime(
        "20120922-12:34:56.123456789111");
    assertEquals(12, dateTime.getHour());
    assertEquals(34, dateTime.getMinute());
    assertEquals(56, dateTime.getSecond());
    assertEquals(2012, dateTime.getYear());
    ...
    assertEquals(
        "20120922-12:34:56",
        UtcTimestampConverter.convert(dateTime, UtcTimestampPrecision.SECONDS));
    assertEquals(
        "20120922-12:34:56.123",
        UtcTimestampConverter.convert(dateTime, UtcTimestampPrecision.MILLIS));
    assertEquals(
        "20120922-12:34:56.123456",
        UtcTimestampConverter.convert(dateTime, UtcTimestampPrecision.MICROS));
    assertEquals(
        "20120922-12:34:56.123456000",
        UtcTimestampConverter.convert(dateTime, UtcTimestampPrecision.NANOS));
  }
  ...
  public void testUtcTimeOnlyConversion() throws Exception {
    ...
    c.setTimeZone(TimeZone.getTimeZone("UTC"));
    c.set(Calendar.MILLISECOND, 555);
    assertEquals("12:05:06", UtcTimeOnlyConverter.convert(c.getTime(), false));
    assertEquals("12:05:06.555",
                 UtcTimeOnlyConverter.convert(c.getTime(), true));
    ...
    LocalTime time =
        UtcTimeOnlyConverter.convertToLocalTime("12:05:06.555444333222");
    ...
    assertEquals("12:05:06", UtcTimeOnlyConverter.convert(
                                 time, UtcTimestampPrecision.SECONDS));
    assertEquals("12:05:06.555", UtcTimeOnlyConverter.convert(
                                     time, UtcTimestampPrecision.MILLIS));
    assertEquals("12:05:06.555444", UtcTimeOnlyConverter.convert(
                                        time, UtcTimestampPrecision.MICROS));
    assertEquals("12:05:06.555444333", UtcTimeOnlyConverter.convert(
                                           time, UtcTimestampPrecision.NANOS));
  }
